...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ws(e,t,n){let r=new Float32Array(As),i=new H(0,1,0);return new oo({name:`SphericalGaussianBlur`,defines:{n:As,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:qs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Gs(){return new oo({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:qs(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ks(){return new oo({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:qs(),fragmentShader:`
	...
	`}var Js=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ci(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var yl={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function bl(e,t){let n=yl[t];return n===void 0?(L(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var xl=new H;function Sl(){return W.getLuminanceCoefficients(xl),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${xl.x.toFixed(4)}, ${xl.y.toFixed(4)}, ${xl.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=dl(i,i.VERTEX_SHADER,y),S=dl(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=_l(i,x,`vertex`),n=_l(i,S,`fragment`);R(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`;var Cd=Hp(`#town-canvas`),wd=Hp(`.viewport-card`),Td=Hp(`#play-button`),Ed=Hp(`#year-readout`),Dd=Hp(`#era-tag`),Od=Hp(`#fleet-readout`),kd=Hp(`#catch-readout`),Ad=Hp(`#buildout-readout`),jd=Hp(`#era-card-title`),Md=Hp(`#era-details`),Nd=Hp(`#era-notes`),Pd=new Map,Fd=new Map;for(let e of vd){let t=document.querySelector(`#slider-${e.key}`),n=document.querySelector(`#value-${e.key}`);if(!t||!n)throw Error(`Missing slider UI for ${e.key}.`);Pd.set(e.key,t),Fd.set(e.key,n)}var Id=new Mu({canvas:Cd,antialias:!0,powerPreference:`high-performance`});Id.setPixelRatio(Math.min(window.devicePixelRatio,2)),Id.outputColorSpace=Ve,Id.toneMapping=4,Id.toneMappingExposure=1.03,Id.shadowMap.enabled=!0,Id.shadowMap.type=2;var Ld=new Ln,Rd=new G(`#8cc9e8`);Ld.background=Rd,Ld.fog=new In(Rd.clone(),62,235);var zd=new Ho(48,1,.1,400);zd.position.set(72,48,78);var Bd=new ud(Id),Vd=new dd(Ld,zd),Hd=new pd(new V(1,1),.24,.52,.76);Bd.addPass(Vd),Bd.addPass(Hd);var Ud=new Uu(zd,Cd);Ud.enableDamping=!0,Ud.dampingFactor=.06,Ud.minDistance=30,Ud.maxDistance=185,Ud.maxPolarAngle=Math.PI*.47,Ud.target.set(6,2.6,8);var Wd=new Ao(`#dff7ff`,`#3e2d22`,1.45),Gd=new qo(`#ffe2aa`,3.1);Gd.position.set(-30,42,24),Gd.castShadow=!0,Gd.shadow.mapSize.set(2048,2048),Gd.shadow.camera.left=-105,Gd.shadow.camera.right=105,Gd.shadow.camera.top=105,Gd.shadow.camera.bottom=-105,Gd.shadow.camera.near=1,Gd.shadow.camera.far=220;var Kd=new qo(`#9dc9ff`,.85);Kd.position.set(25,20,-28),Ld.add(Wd,Gd,Kd);var qd=new On,Jd=new On,Yd=new On,Xd=new On,Zd=new On;Ld.add(qd,Jd,Yd,Xd,Zd);var Qd=[],$d=[],ef=[],tf=[],nf=[],rf=[],af=null,of=wf(),sf=of.getAttribute(`position`),cf=Float32Array.from(sf.array),lf=new lo({color:`#0f7fa4`,map:bp(`water`,`#0f7fa4`),roughness:.18,metalness:.02,clearcoat:.82,clearcoatRoughness:.16,transmission:.03,transparent:!0,opacity:.9}),uf=new q(of,lf);uf.receiveShadow=!0,qd.add(uf);var df=hp();qd.add(df),Df();var ff=!1,pf=X.year,mf=``,hf=0;for(let e of vd){let t=Pd.get(e.key);t.addEventListener(`input`,()=>{X[e.key]=Number(t.value),e.key===`year`&&(pf=X.year),vf()})}Td.addEventListener(`click`,()=>{ff=!ff,Td.setAttribute(`aria-pressed`,String(ff)),Td.textContent=ff?`⏸ Pause`:`▶ Play`}),window.addEventListener(`resize`,_f),_f(),vf();var gf=new fs;Id.setAnimationLoop(()=>{let e=Math.min(gf.getDelta(),.04),t=gf.elapsedTime;if(ff){pf+=e*zp(pf),pf>hd&&(pf=md);let t=Math.round(pf);t!==X.year&&(X.year=t,vf())}Nf(t),Pf(t),Ff(t),If(t,e),Ud.update(),Bd.render()});function _f(){let e=wd.getBoundingClientRect(),t=Math.max(1,Math.floor(e.width)),n=Math.max(1,Math.floor(e.height));Id.setSize(t,n,!1),Bd.setSize(t,n),Hd.setSize(t,n),zd.aspect=t/n,zd.updateProjectionMatrix()}function vf(){X.year=Vp(Math.round(X.year),md,hd);let e=vd.map(e=>X[e.key]).join(`|`);yf(),e!==mf&&(mf=e,Of(),kf(),Af(),jf(),Mf())}function yf(){let e=Sf(X.year),t=Cf();for(let e of vd){let t=Pd.get(e.key),n=Fd.get(e.key);t.value=String(X[e.key]),n.value=bf(e,X[e.key])}Ed.textContent=xf(X.year),Dd.textContent=e.tag,Od.textContent=`${t.fleet} vessels`,kd.textContent=`${t.catchIndex} kt`,Ad.textContent=`${t.buildout}%`,jd.textContent=e.name,Md.textContent=e.details,Nd.innerHTML=e.notes.map(e=>`<li>${e}</li>`).join(``)}function bf(e,t){return e.key===`year`?xf(t):`${Math.round(t)}${e.suffix}`}function xf(e){let t=Math.round(e);return t<0?`${Math.abs(t)} BC`:`${t}`}function Sf(e){return[..._d].reverse().find(t=>e>=t.from)??_d[0]}function Cf(){let e=Bp(X.year,900,1990),t=Bp(X.year,1840,1970),n=Bp(X.year,1960,1990),r=Vp(Math.round(1+X.population*.07+X.industry*.115+X.fishStock*.045+X.tourism*.035+e*14+t*12+n*10),2,72),i=1-X.storminess*.0045,a=.55+X.fishStock/180,o=Vp(Math.round(r*(.22+e*.2+t*.92)*i*a),1,140),s=Vp(Math.round(X.seaLevel*.48+X.storminess*.42+Math.max(0,48-X.fishStock)*.26),0,100);return{buildout:Vp(Math.round(Bp(X.year,md,hd)*38+e*28+t*20+n*16+X.population*.18+X.industry*.18+X.tourism*.08),4,100),catchIndex:o,coastalExposure:s,fleet:r}}function wf(){let e=[],t=[],n=[],r=-150,i=-128,a=2.4;for(let o=r;o<150;o+=a)for(let s=i;s<34;s+=a){if(!Tf(o+a/2,s+a/2))continue;let c=[[o,0,s],[o+a,0,s],[o+a,0,s+a],[o,0,s],[o+a,0,s+a],[o,0,s+a]];for(let[a,o,s]of c)e.push(a,o,s),t.push(0,1,0),n.push((a-r)/(150-r),(s-i)/(34-i))}let o=new Ar;return o.setAttribute(`position`,new K(e,3)),o.setAttribute(`normal`,new K(t,3)),o.setAttribute(`uv`,new K(n,2)),o}function Tf(e,t){return t<Ef(e)-.35}function Ef(e){for(let t=0;t<xd.length-1;t+=1){let[n,r]=xd[t],[i,a]=xd[t+1];if(e>=n&&e<=i){let t=(e-n)/(i-n);return At.lerp(r,a,t)}}return e<xd[0][0]?xd[0][1]:xd[xd.length-1][1]}function Df(){let e=new ca;Fp(e,-126,62),Ip(e,-126,9),Lp(e,-110,6,-100,1,-92,-2),Lp(e,-76,-5,-61,-13,-45,-9),Lp(e,-34,-2.8,-24,-.4,-16,-8),Lp(e,-8,-16,4,-14,16,-7),Lp(e,30,-1.2,44,3,59,10.5),Lp(e,78,18,99,24,124,28),Ip(e,128,64),Ip(e,-126,62);let t=new Ja(e,18);t.rotateX(-Math.PI/2);let n=new q(t,Q(`#6f8d52`,.92,`grass`,0));n.position.y=.08,n.receiveShadow=!0,qd.add(n);let r=Q(`#d9c08a`,.86,`sand`,0);r.side=2;let i=new q(new qa(15,25,96,1,.18,Math.PI*.74),r);i.rotation.x=-Math.PI/2,i.rotation.z=.11,i.position.set(-1.2,.105,-7.2),i.scale.set(2.35,.86,1),qd.add(i),gp(-86,34,16,6.1,`#4f713f`),gp(-65,47,12,4.8,`#5a7b46`),gp(-34,31,10,4.2,`#4f713f`),gp(-23,39,7,2.8,`#5a7b46`),gp(31,38,11,4.7,`#557844`),gp(42,28,7,3.1,`#466a39`),gp(74,41,15,5.8,`#557844`),gp(98,33,10,3.9,`#466a39`);for(let[e,t,n]of[[-102,18,1.15],[-94,28,.9],[-82,42,1.3],[-72,29,.8],[-58,38,1.05],[-48,25,.9],[-38,13,1.2],[-34,16,.9],[-29,19,1.1],[-21,20,.8],[-13,19,.85],[10,22,1],[15,18,.8],[23,19,1.15],[29,14,.9],[36,18,1.2],[41,13,.75],[-45,8,.8],[54,31,1.1],[68,38,.95],[84,32,1.25],[101,40,.82]])qd.add(_p(e,t,n))}function Of(){Wp(Jd),$d.length=0;let e=Rp();Qf(e);let t=Vp(9+Bp(X.year,md,hd)*36+X.industry*.11,9,52);if(Jd.add(Xf(-8,-6.8,t,X.year<900?1.15:2.1,-.08,X.year<200?`#9b7651`:`#8b6444`)),X.year>=200&&Zf(-11,-2.7,12+Bp(X.year,200,1450)*8,2.25,.03,`#8c908a`),X.year>=900&&(Jd.add(Xf(4.5,-7.2,t*.72,1.7,.13,`#7a6045`)),Zf(8,-2.7,15+Bp(X.year,900,1880)*9,2.7,-.04,`#92958d`),$f()),X.year>=1750&&(Jd.add(Xf(-20,-8.2,t*.56,1.4,-.35,`#8b6444`)),Jd.add(Xf(28,-8.8,t*.5,1.25,.32,`#8b6444`))),X.year>=1880&&(Zf(-31,-8.3,30,2.6,-.32,`#9da1a1`),Zf(31,-8.6,32,2.6,.32,`#9da1a1`),ep(-22,-6.1,.95),ep(18,-6.4,1.05),ep(38,-7.6,.92)),X.year>=1930&&(Zf(4,-15.4,46,3.4,.02,`#a7a9a8`),ep(3,-12.5,1.18),ep(-9,-13.2,1.05)),X.year>=1965&&X.industry>42&&tp(),X.year>=1985&&X.industry>70&&(Jd.add(up(-64,-28,1.1)),Jd.add(up(63,-30,.95))),X.year>=1970&&X.tourism>34){let e=Math.round(3+X.tourism/14);for(let t=0;t<e;t+=1){let e=9+t*2.25;Jd.add(Xf(e,-10.5,7.5,.48,.03,`#c7ad80`)),t%2==0&&Jd.add(Xf(-34+t*2.2,-11.8,8.2,.48,-.18,`#c7ad80`))}}(Cf().coastalExposure>57||X.year>=1965&&X.seaLevel>55)&&np(e),Up(Jd)}function kf(){Wp(Yd),Qd.length=0,ef.length=0,nf.length=0,X.year>=200&&rp(-12,9.2,78,1.15,-.04),X.year>=900&&(rp(4,15.2,118,.95,.02),rp(-38,20.2,1,30,.04),rp(34,20.8,1,28,-.05)),X.year>=1880&&(rp(4,1.5,72,1.05,.07),rp(-54,26.4,1.05,31,.08),rp(58,27.4,1.05,30,-.06)),X.year>=1930&&(rp(2,24.2,148,1.45,-.03),rp(-30,13,1.1,39,.03),rp(30,14,1.1,38,-.06),rp(0,38.5,132,1.2,.01)),ip(),ap();let e=Vp(Math.round(3+X.population/13+Bp(X.year,-500,1750)*11),X.year<0?3:6,bd.length);for(let t=0;t<e;t+=1){let[e,n,r]=bd[t],i=t%3,a=X.year<900,o=a?[`#b99561`,`#c59f68`,`#a87945`]:[`#c58f65`,`#d6b182`,`#b87f58`],s=a?[`#8a6a39`,`#7c5b32`,`#6b4423`]:[`#654321`,`#74422d`,`#4b5563`];Yd.add(Lf({name:`Fisher cottage ${t+1}`,year:1740,x:e,z:n,w:2.7+t%2*.4,d:2.4,h:2+t%3*.18,color:o[i],roof:s[i],rotation:r,kind:a?`hut`:`cottage`}))}for(let e of yd)X.year<e.year||e.condition&&!e.condition(X)||e.name!==`Lighthouse`&&Yd.add(Lf(e));if(op(),X.year>=1750&&Yd.add(Gf(-29,-5.8)),X.year>=1930&&X.industry>48&&Yd.add(cp(-25,-1.7)),X.year>=1930){let e=Vp(Math.round((X.population+X.industry)/18),5,24);for(let t=0;t<e;t+=1){let e=dp(-62+t*5.2,3+t%2*2.2,t%2?`#f59e0b`:`#2563eb`);e.userData.index=t,nf.push(e),Yd.add(e)}}X.year>=1988&&lp(20.5,5.4,X.tourism>45?7:4),Up(Yd)}function Af(){Wp(Xd),tf.length=0;let{fleet:e}=Cf(),t=Vp(Math.round(e*.94),X.year<0?5:8,52),n=[[-12,-13,-.08],[-7,-15.8,.12],[-2.5,-12.6,-.22],[4,-15.4,.18],[10,-12.6,-.12],[15,-16.2,.08],[-18,-10.5,.3],[21,-11.5,-.32],[-23,-14.8,.24],[27,-15.3,-.24],[1,-20.3,.04],[-7,-21.4,-.18],[11,-21.8,.18],[-29,-10.7,.45],[31,-10.9,-.45],[-17,-19.9,.14],[21,-20.5,-.12],[0,-9.8,.03],[-38,-18.3,.35],[39,-18.7,-.32],[-33,-26.4,.22],[33,-28.5,-.18],[6,-30.2,.08],[-4,-33.5,-.1],[18,-31.6,.16],[-20,-30.1,-.16],[-51,-28.7,.28],[49,-29.4,-.24],[-62,-38.4,.18],[61,-40.6,-.2],[-43,-48.6,.3],[42,-51.2,-.26],[-12,-44.1,.08],[15,-46.5,-.1],[-72,-21.6,.38],[72,-24.4,-.34]];for(let e=0;e<t;e+=1){let[t,r,i]=n[e%n.length],a=qf(Yf(e),e);a.position.set(t+$(e)*1.1,Rp()+.38,r+$(e+4)*.9),a.rotation.y=i+$(e+8)*.14,a.userData.baseY=a.position.y,a.userData.phase=$(e+14)*Math.PI*2,e%5==0&&(a.userData.route={startX:-48+$(e+21)*18,endX:46-$(e+24)*20,z:-25-$(e+27)*18,speed:.018+$(e+30)*.025}),tf.push(a),Xd.add(a)}let r=Vp(Math.round(X.fishStock/5),2,20);df.visible=X.fishStock>18,df.children.forEach((e,t)=>{e.visible=t<r}),Up(Xd)}function jf(){Wp(Zd),rf.length=0,af=null;let e=Vp(Math.round(8+X.storminess/7),8,24);for(let t=0;t<e;t+=1){let n=fp(-82+164/e*t+$(t)*7,20+$(t+3)*9,-46+$(t+6)*34,.9+$(t+9)*.7);n.userData.speed=.16+$(t+11)*.18,Zd.add(n)}let t=Vp(Math.round(7+X.tourism/14-X.storminess/18),2,12);for(let e=0;e<t;e+=1){let t=pp(e);rf.push(t),Zd.add(t)}X.storminess>58&&(af=mp(),Zd.add(af))}function Mf(){let e=X.storminess/100,t=Bp(X.year,1965,1990),n=1-Bp(X.year,-500,1750);Rd.setHSL(.55-n*.04,.68-e*.36,.66-e*.25),Ld.background=Rd,Ld.fog=new In(Rd.clone(),58-e*16,235-e*70),Wd.intensity=1.25-e*.34+t*.12,Gd.intensity=3.6-e*2.2,Kd.intensity=.82+e*.28,lf.color.setHSL(.53,.72-e*.24,.39-e*.13),lf.roughness=.16+e*.34,Hd.strength=.2+t*.12+(1-e)*.03,Id.toneMappingExposure=1.12-e*.24}function Nf(e){let t=X.storminess/100,n=.18+t*.72,r=Rp();for(let i=0;i<sf.count;i+=1){let a=cf[i*3],o=cf[i*3+2],s=r+Math.sin(a*.16+e*(.85+t))*n*.44+Math.cos(o*.18+e*(1.1+t*1.4))*n*.28+Math.sin((a+o)*.07+e*.42)*n*.18;sf.setY(i,s)}sf.needsUpdate=!0,hf+=1,hf%5==0&&of.computeVertexNormals()}function Pf(e){let t=X.storminess/100,n=Rp();for(let r of tf){let i=r.userData.phase,a=r.userData.route;if(a){let t=(e*a.speed+i*.03)%1;r.position.x=At.lerp(a.startX,a.endX,t),r.position.z=a.z+Math.sin(t*Math.PI*2+i)*1.2,r.rotation.y=a.startX<a.endX?Math.PI/2:-Math.PI/2}r.position.y=n+.38+Math.sin(e*1.7+i)*(.08+t*.34),r.rotation.z=Math.sin(e*1.25+i)*(.025+t*.075),r.rotation.x=Math.cos(e*1.08+i)*(.018+t*.06)}for(let e of Qd)e.rotation.y+=.012+t*.006;for(let e of $d)e.rotation.z+=.04+t*.06}function Ff(e){for(let t of nf){let n=t.userData.index,r=(e*(.15+n%4*.025)+n*.17)%1;t.position.x=-66+r*132,t.position.z=3+n%2*2.2+Math.sin(e*.6+n)*.15,t.rotation.y=Math.PI/2}}function If(e,t){for(let e of Zd.children)e.userData.speed&&(e.position.x+=e.userData.speed*t*(1+X.storminess/80),e.position.x>92&&(e.position.x=-92));for(let t of rf){let n=t.userData.index,r=16+n%4*5,i=e*(.18+n*.013)+n;t.position.set(Math.cos(i)*r+$(n)*7,9+Math.sin(e*1.7+n)*1.1+n%3,-12+Math.sin(i)*r*.42),t.rotation.y=-i+Math.PI/2,t.rotation.z=Math.sin(e*6+n)*.22}af&&(af.position.y-=t*(18+X.storminess*.14),af.position.y<-10&&(af.position.y=16));for(let t of ef){let n=t.userData.phase,r=t.userData.baseY;t.position.y=r+(e*.55+n)%2.6,t.position.x+=Math.sin(e+n)*.0015;let i=t.material;i instanceof co&&(i.opacity=.26-(t.position.y-r)/2.6*.15)}df.children.forEach((t,n)=>{t.position.y=Rp()+.08+Math.sin(e*2+n)*.06,t.rotation.y+=.01+n*8e-4})}function Lf(e){let t=new On;if(t.name=e.name,t.position.set(e.x,.16,e.z),t.rotation.y=e.rotation??0,e.kind===`hut`){let n=new q(new Ai(e.w*.42,e.w*.5,e.h,10),Q(e.color,.86,`wood`));n.position.y=e.h/2;let r=new q(new ji(e.w*.62,e.h*.85,10),Q(e.roof,.92,`roof`));return r.position.y=e.h+e.h*.36,t.add(n,r),zf(t,e),t}let n=Rf(e),r=Z(e.w,e.h,e.d,e.color,0,e.h/2,0,n),i=e.kind===`cottage`||e.kind===`market`||e.kind===`hotel`?`stone`:`concrete`;t.add(Z(e.w+.36,.28,e.d+.36,`#6b6f68`,0,.13,0,i,.86),r);let a=e.kind===`industrial`||e.kind===`research`||e.kind===`warehouse`||e.kind===`apartment`||e.kind===`office`||e.kind===`highrise`||e.kind===`port`||e.kind===`fort`;if(a)t.add(Z(e.w+.35,.34,e.d+.35,e.roof,0,e.h+.17,0,`roof`,.68));else{let n=Mp(e.w+.55,e.d+.62,.9,e.roof);n.position.y=e.h,t.add(n)}if(Bf(t,e,a),Uf(t,e),t.add(Z(.58,.92,.08,`#3d281d`,0,.58,-e.d/2-.055,`wood`,.76)),e.kind===`chapel`||e.kind===`temple`){t.add(Z(1.05,2.6,1,e.color,0,e.h+1.25,-e.d*.34,n));let r=new q(new ji(.72,e.kind===`temple`?.9:1.45,e.kind===`temple`?6:4),Q(e.kind===`temple`?`#a16207`:`#4b5460`,.82,`roof`));r.position.set(0,e.h+3.25,-e.d*.34),r.rotation.y=Math.PI/4,t.add(r)}if(e.kind===`fort`)for(let n of[-e.w/2+.42,e.w/2-.42]){let r=new q(new Ai(.48,.56,e.h*1.18,12),Q(e.color,.88,`stone`));r.position.set(n,e.h*1.18/2,-e.d/2+.35),t.add(r)}if(e.kind===`industrial`){let n=e.h+2.5,r=new q(new Ai(.34,.44,n,14),Q(`#3f332d`,.88,`stone`));r.position.set(e.w*.34,n/2,e.d*.16),t.add(r),X.year>=1880&&X.industry>28&&vp(t,r.position.x,n+.8,r.position.z),t.add(Z(e.w*.78,.12,.14,`#f1f5d8`,0,e.h*.58,-e.d/2-.07,`metal`,.42)),Vf(t,e)}if(e.kind===`market`&&(t.add(Z(e.w*.82,.34,.12,`#fef3c7`,0,e.h*.72,-e.d/2-.09,`wood`,.62)),yp(t,e.w,e.d,`#e11d48`)),e.kind===`hotel`&&(t.add(Z(e.w*.68,.2,.16,`#fff7ed`,0,e.h*.3,-e.d/2-.1,`metal`,.4)),yp(t,e.w*.75,e.d,`#0f766e`)),e.kind===`research`){let n=new q(new Xa(1.05,20,12,0,Math.PI*2,0,Math.PI/2),new co({color:`#a7f3d0`,roughness:.18,metalness:.02,transparent:!0,opacity:.72}));n.position.set(-e.w*.24,e.h+.15,0),t.add(n)}if(e.kind===`highrise`||e.kind===`office`){Hf(t,e);let n=new q(new Ai(.045,.065,2.1,8),Q(`#cbd5e1`,.35,`metal`,.2));n.position.set(e.w*.25,e.h+1.2,e.d*.2),t.add(n)}return t}function Rf(e){return e.kind===`industrial`||e.kind===`warehouse`||e.kind===`port`?X.year>=1880?`concrete`:`stone`:e.kind===`fort`||e.kind===`chapel`||e.kind===`temple`?`stone`:e.kind===`office`||e.kind===`highrise`||e.kind===`research`?`glass`:e.kind===`apartment`?`plaster`:X.year<900?`wood`:`plaster`}function zf(e,t){e.add(Z(.5,.76,.08,`#4a2f1b`,0,.46,-t.w*.43,`wood`,.8));for(let n=0;n<3;n+=1){let r=new q(new Za(t.w*(.42+n*.025),.025,6,18),Q(`#d5b174`,.85,`wood`));r.position.y=.42+n*.38,r.rotation.x=Math.PI/2,e.add(r)}for(let n=0;n<8;n+=1){let r=n/8*Math.PI*2,i=Z(.045,t.h*.86,.045,`#6b4423`,Math.cos(r)*t.w*.45,t.h*.46,Math.sin(r)*t.w*.45,`wood`,.86);i.rotation.y=r,e.add(i)}}function Bf(e,t,n){let r=t.kind===`office`||t.kind===`highrise`?`#dbeafe`:t.kind===`industrial`||t.kind===`warehouse`?`#475569`:`#f8e6c2`,i=t.kind===`office`||t.kind===`highrise`?`metal`:`wood`;if(e.add(Z(t.w+.18,.12,.14,r,0,.42,-t.d/2-.08,i,.55)),n)e.add(Z(t.w+.55,.16,.18,r,0,t.h+.48,-t.d/2-.1,i,.5)),e.add(Z(.18,.16,t.d+.55,r,-t.w/2-.1,t.h+.48,0,i,.5)),e.add(Z(.18,.16,t.d+.55,r,t.w/2+.1,t.h+.48,0,i,.5));else{let n=Z(.16,.18,t.d+.72,r,0,t.h+.9,0,i,.55);n.rotation.z=Math.PI/4,e.add(n),(t.kind===`cottage`||t.kind===`hotel`||t.kind===`market`)&&e.add(Z(.42,1.05,.42,`#5b3a24`,t.w*.24,t.h+.54,t.d*.12,`stone`,.78))}if(t.kind===`cottage`||t.kind===`market`||t.kind===`hotel`){let n=t.kind===`market`?`#16a34a`:`#2f6f3e`;e.add(Z(.82,.22,.22,n,-t.w*.32,.42,-t.d/2-.14,`wood`,.78)),e.add(Z(.82,.22,.22,n,t.w*.32,.42,-t.d/2-.14,`wood`,.78))}}function Vf(e,t){e.add(Z(t.w*.42,.72,.16,`#334155`,-t.w*.24,.64,-t.d/2-.12,`metal`,.42)),e.add(Z(t.w*.56,.16,.72,`#64748b`,-t.w*.12,.28,-t.d/2-.42,`metal`,.48));for(let n=0;n<3;n+=1){let r=new q(new Ai(.22,.28,.32,12),Q(`#94a3b8`,.45,`metal`,.18));r.position.set(-t.w*.28+n*.7,t.h+.58,t.d*.12),e.add(r)}for(let n=0;n<2;n+=1){let r=new q(new Ai(.065,.065,t.h*.8,8),Q(`#475569`,.5,`metal`,.22));r.position.set(-t.w/2-.08,t.h*.44,-t.d*.2+n*t.d*.32),e.add(r)}}function Hf(e,t){let n=t.h+.72;e.add(Z(t.w*.36,.45,t.d*.28,`#cbd5e1`,-t.w*.18,n,0,`metal`,.38)),e.add(Z(t.w*.22,.3,t.d*.2,`#64748b`,t.w*.24,n-.06,t.d*.18,`metal`,.4));let r=Math.min(5,Math.floor(t.h/2.2));for(let n=0;n<r;n+=1){let r=1.45+n*1.55;e.add(Z(t.w*.78,.08,.26,`#dbeafe`,0,r,-t.d/2-.18,`metal`,.34))}}function Uf(e,t){let n=t.kind===`highrise`?Math.max(6,Math.floor(t.h/1.15)):t.kind===`office`||t.kind===`apartment`||t.kind===`hotel`?Math.max(3,Math.floor(t.h/1.25)):t.h>3?2:1,r=Math.max(2,Math.floor(t.w/(t.kind===`highrise`?.9:1.35))),i=new co({color:`#ffd98a`,map:bp(`glass`,`#9bdcf4`),emissive:`#ffb84d`,emissiveIntensity:.18+X.storminess/350,roughness:.35}),a=Q(`#1f2937`,.52,`metal`,.12),o=Math.max(2,Math.floor(t.d/1.25));for(let s=0;s<n;s+=1)for(let c=0;c<r;c+=1){if(t.kind===`industrial`&&(c+s)%2==0)continue;let l=-t.w*.36+c*(t.w*.72/Math.max(1,r-1)),u=.95+s*(t.h/(n+.7)),d=new q(new Oi(.42,.48,.045),i);if(d.position.set(l,u,-t.d/2-.045),e.add(d),e.add(Wf(.52,.58,a,l,u,-t.d/2-.075,!1)),t.kind===`highrise`||t.kind===`office`){let n=-t.d*.32+c%o*(t.d*.64/Math.max(1,o-1)),r=new q(new Oi(.045,.42,.42),i);r.position.set(t.w/2+.045,u,n),e.add(r)}}}function Wf(e,t,n,r,i,a,o){let s=new On,c=o?new Oi(.04,.045,e):new Oi(e,.045,.04),l=o?new Oi(.04,t,.045):new Oi(.045,t,.04),u=new q(c,n),d=new q(c,n),f=new q(l,n),p=new q(l,n);return u.position.y=t/2,d.position.y=-t/2,o?(f.position.z=-e/2,p.position.z=e/2):(f.position.x=-e/2,p.position.x=e/2),s.position.set(r,i,a),s.add(u,d,f,p),s}function Gf(e,t){let n=new On;n.name=`Lighthouse`,n.position.set(e,.2,t);for(let e=0;e<6;e+=1){let t=new q(new Ai(.78-e*.045,.9-e*.045,.82,20),Q(e%2==0?`#f8fafc`:`#b91c1c`,.78));t.position.y=.42+e*.82,n.add(t)}let r=new q(new Ai(.95,.95,.6,18),Q(`#263238`,.45));r.position.y=5.45,n.add(r);let i=new Wo(`#ffd166`,1.8,36,1.6);i.position.set(0,5.5,0),n.add(i);let a=new Vr({color:`#ffe8a3`,transparent:!0,opacity:.18,depthWrite:!1,side:2}),o=new q(new ji(2.4,20,32,1,!0),a);o.position.set(8.7,5.48,0),o.rotation.z=-Math.PI/2,Qd.push(o),n.add(o);let s=new q(new ji(1.15,.9,18),Q(`#991b1b`,.68));return s.position.y=6.2,n.add(s),n}function Kf(e,t,n,r,i=0){let a=new q(new Ai(.045*t,.065*t,3.2*t,8),Q(`#3d281d`,.7,`wood`));if(a.position.set(0,1.75*t,i),e.add(a),r===`square`){let r=new q(new Ka(1.55*t,1.45*t),new co({color:n,map:bp(`sail`,n),roughness:.88,side:2}));r.position.set(0,2.05*t,i-.03),e.add(r);return}let o=r===`lateen`?[[-.62*t,.6*t,i],[.2*t,2.9*t,i],[1.5*t,.9*t,i]]:[[.06*t,.45*t,i],[.06*t,2.8*t,i],[1.35*t,.7*t,i]];e.add(Pp(o,n))}function qf(e,t){let n=new On;n.name=`${e} boat`;let r=[`#b91c1c`,`#0f766e`,`#1d4ed8`,`#f59e0b`,`#f8fafc`,`#7c3aed`,`#0f172a`],i=r[t%r.length],a=e===`factory`||e===`container`?2.35:e===`ferry`?1.85:e===`trawler`?1.35:e===`steamer`?1.18:e===`yacht`?.9:e===`dugout`?.58:e===`galley`?1:.92,o=new q(Np(1.65*a,.75*a,4.3*a),Q(i,.56,`hull`));if(o.position.y=.25*a,n.add(o),e===`dugout`)n.add(Z(.1*a,.08*a,4.2*a,`#3d281d`,-.52*a,.65*a,0,`wood`,.8)),n.add(Z(.1*a,.08*a,4.2*a,`#3d281d`,.52*a,.65*a,0,`wood`,.8));else if(e===`galley`){Kf(n,a,`#f7e7bd`,`square`);for(let e=0;e<8;e+=1){let t=Z(.08*a,.04*a,1.7*a,`#5b3a24`,-.86*a,.55*a,-1.6*a+e*.45*a,`wood`,.78),r=Z(.08*a,.04*a,1.7*a,`#5b3a24`,.86*a,.55*a,-1.6*a+e*.45*a,`wood`,.78);t.rotation.z=.8,r.rotation.z=-.8,n.add(t,r)}}else if(e===`cog`||e===`caravel`||e===`lugger`||e===`schooner`)Kf(n,a,e===`cog`?`#f4deb3`:`#f8fafc`,e===`cog`?`square`:`lateen`),(e===`caravel`||e===`schooner`)&&Kf(n,a*.82,`#fff7ed`,`triangle`,-.95*a);else if(e===`sail`){let e=new q(new Ai(.045,.06,3.1*a,8),Q(`#4b3427`,.7,`wood`));e.position.y=1.78*a,n.add(e);let t=Pp([[.08,.5,0],[.08,2.8*a,0],[1.45*a,.75,0]],`#f7f0dc`);t.position.z=-.18,n.add(t)}else{let i=e===`yacht`||e===`ferry`?`#ffffff`:`#e2e8f0`;if(n.add(Z((e===`factory`||e===`container`?1.55:1.05)*a,.8*a,1.05*a,i,0,.88*a,-.38*a,`metal`,.38)),e!==`yacht`&&e!==`ferry`){let e=new q(new Oi(.12,.12,3.4*a),Q(`#2f2a24`,.7,`metal`));e.position.set(.72*a,1.32*a,.56*a),e.rotation.x=-.35,n.add(e),n.add(Z(.95*a,.08*a,1.55*a,`#64748b`,-.75*a,.82*a,.65*a,`metal`,.46))}if(e===`factory`||e===`container`)for(let e=0;e<7;e+=1)n.add(Z(.62*a,.34*a,.48*a,r[(t+e+2)%r.length],-1.2*a+e*.4*a,1.12*a,.62*a,`metal`,.48));e===`ferry`&&(n.add(Z(1.4*a,.35*a,2.8*a,`#dbeafe`,0,1.32*a,.15*a,`glass`,.28)),n.add(Z(1.55*a,.14*a,3.15*a,`#1e3a8a`,0,.82*a,.15*a,`metal`,.42)))}if(e===`steamer`||e===`factory`||e===`ferry`){let e=new q(new Ai(.15,.18,.95*a,10),Q(`#2f2a24`,.65,`metal`));e.position.set(.45*a,1.35*a,-.62*a),n.add(e)}return Jf(n,e,a,t,i),n}function Jf(e,t,n,r,i){let a=t===`factory`||t===`container`?5.8:t===`ferry`?4.9:3.35,o=t===`factory`||t===`container`?1.85:t===`ferry`?1.6:1.18;e.add(Z(o*n,.08*n,a*n,`#b98b5f`,0,.74*n,-.08*n,`wood`,.74)),e.add(Z(o*n,.08*n,.16*n,i,0,.86*n,-a*.48*n,`hull`,.52));for(let t of[-1,1]){e.add(Z(.055*n,.16*n,a*.78*n,`#f8fafc`,t*o*.53*n,1*n,-.1*n,`metal`,.36));for(let r=0;r<4;r+=1)e.add(Z(.055*n,.36*n,.055*n,`#cbd5e1`,t*o*.53*n,.88*n,(-a*.35+r*a*.23)*n,`metal`,.38))}if(t!==`dugout`&&t!==`galley`&&t!==`cog`&&t!==`caravel`&&t!==`lugger`&&t!==`schooner`&&t!==`sail`)for(let t=0;t<3;t+=1)e.add(Z(.22*n,.22*n,.035*n,`#9bdcf4`,(-.32+t*.32)*n,1.05*n,-.92*n,`glass`,.2));if(t===`trawler`||t===`steamer`||t===`factory`){let t=new q(new Za(.34*n,.045*n,8,18),Q(`#7c4a2d`,.72,`wood`));t.position.set(-.58*n,1.02*n,.72*n),t.rotation.y=Math.PI/2,e.add(t),e.add(Z(1.05*n,.035*n,.62*n,`#1f2937`,-.72*n,.98*n,.9*n,`rubber`,.78))}if(t===`container`||t===`factory`){e.add(Z(.13*n,1.08*n,.13*n,`#fbbf24`,1.02*n,1.64*n,.25*n,`metal`,.34));let t=Z(2.2*n,.09*n,.09*n,`#f59e0b`,.22*n,2.15*n,.25*n,`metal`,.34);t.rotation.z=-.18,e.add(t)}if(t===`cog`||t===`caravel`||t===`lugger`||t===`schooner`||t===`sail`||t===`galley`){let t=new Ar;t.setAttribute(`position`,new K([0,2.95*n,0,-.72*n,.82*n,-1.72*n,0,2.95*n,0,.72*n,.82*n,1.62*n,0,2.5*n,0,0,.82*n,-1.92*n],3)),e.add(new Si(t,new ui({color:`#2f241f`,transparent:!0,opacity:.72})))}r%3==0&&e.add(Z(.54*n,.22*n,.28*n,`#fef3c7`,-.4*n,.9*n,.2*n,`wood`,.68))}function Yf(e){return X.year<0?e%3==0?`galley`:`dugout`:X.year<900?e%3==0?`galley`:`lugger`:X.year<1450?e%4==0?`cog`:`lugger`:X.year<1750?e%4==0?`caravel`:`lugger`:X.year<1880?e%3==0?`schooner`:`lugger`:X.year<1930?e%3==0?`steamer`:`schooner`:X.year>=1965&&X.industry>55&&e%8==0?e%16==0?`container`:`factory`:X.year>=1965&&X.tourism>45&&e%6==0?`ferry`:X.year>=1970&&X.tourism>42&&e%4==0?`yacht`:e%5==0&&X.year<1960?`steamer`:`trawler`}function Xf(e,t,n,r,i,a){let o=new On;o.position.set(e,0,t),o.rotation.y=i,o.add(Z(r,.25,n,a,0,.36,-n/2,`wood`,.72));let s=Q(`#4b3427`,.7,`wood`);for(let e=0;e<Math.floor(n/2.4);e+=1)for(let t of[-1,1]){let n=new q(new Ai(.12,.15,1.25,8),s);n.position.set((r/2-.12)*t,-.12,-1.2-e*2.35),o.add(n)}return o}function Zf(e,t,n,r,i,a){let o=Z(n,.72,r,a,e,.28,t,`concrete`,.82);o.rotation.y=i,Jd.add(o)}function Qf(e){let t=new ui({color:`#dffcff`,transparent:!0,opacity:.55}),n=new Vi(xd.map(([t,n])=>new H(t,e+.035,n-.28))),r=new vi(new Ar().setFromPoints(n.getPoints(110)),t);Jd.add(r)}function $f(){for(let e=0;e<xd.length-1;e+=2){let[t,n]=xd[e],[r,i]=xd[e+1],a=Z(Math.hypot(r-t,i-n),.55,.34,`#7c8178`,(t+r)/2,.42,(n+i)/2+.2,`stone`,.86);a.rotation.y=Math.atan2(i-n,r-t),Jd.add(a)}}function ep(e,t,n){let r=new On;r.position.set(e,.42,t),r.add(Z(.42*n,4.2*n,.42*n,`#f59e0b`,0,2.1*n,0,`metal`,.36));let i=Z(5.8*n,.22*n,.22*n,`#fbbf24`,2.7*n,4.15*n,0,`metal`,.36);i.rotation.z=.14,r.add(i),r.add(Z(.16*n,1.2*n,.16*n,`#111827`,5.1*n,3.45*n,0,`metal`,.44)),Jd.add(r)}function tp(){Zf(38,-19.2,45,5.2,.02,`#9ca3af`);for(let e=0;e<64;e+=1){let t=Math.floor(e/12),n=[`#dc2626`,`#2563eb`,`#f97316`,`#16a34a`,`#eab308`][e%5],r=Z(1.75,.7,.82,n,20+e%12*2.15,.92+(e%3==0?.72:0),-21.4-t*1.15,`metal`,.48);Jd.add(r)}ep(21,-15.8,1.3),ep(34,-16.1,1.45),ep(47,-16.4,1.25),ep(59,-16.7,1.18)}function np(e){let t=e>1.1?`#d97706`:`#f59e0b`;for(let e=0;e<9;e+=1){let n=Z(2.1,.34,.32,t,-13+e*3.4,.72,-1.35,`wood`,.7);n.rotation.y=.02,Jd.add(n)}}function rp(e,t,n,r,i){let a=Z(n,.05,r,`#756b5a`,e,.19,t,`road`,.88);a.rotation.y=i,Yd.add(a)}function ip(){if(!(X.year>1935&&X.industry>70))for(let e=0;e<4;e+=1){let t=new On;t.position.set(-18+e*2.2,.25,4.1+e%2*1.25),t.rotation.y=-.18,t.add(Z(1.7,.08,.08,`#5b4636`,0,1.2,0,`wood`,.78));for(let e of[-.7,.7])t.add(Z(.08,1.15,.08,`#5b4636`,e,.68,0,`wood`,.78));for(let e=0;e<4;e+=1)t.add(Z(.18,.76,.035,`#e8d5a9`,-.55+e*.36,.72,-.04,`sail`,.88));Yd.add(t)}}function ap(){let e=X.year<900?8:X.year<1880?16:28;for(let t=0;t<e;t+=1){let e=-34+t%14*5.1+$(t)*.5,n=-1.3+Math.floor(t/14)*2.2+$(t+4)*.4,r=t%4==0?`#7c4a2d`:t%4==1?`#a16207`:t%4==2?`#475569`:`#b45309`;Yd.add(Z(.92,.52,.72,r,e,.48,n,t%4==2?`metal`:`wood`,.74))}let t=X.year>=1750?14:6;for(let e=0;e<t;e+=1){let t=new q(new Ai(.28,.32,.62,12),Q(`#7c4a2d`,.76,`wood`));t.position.set(-22+e*2.4,.52,2.2+e%2*1.4),t.rotation.z=e%3==0?Math.PI/2:0,Yd.add(t)}if(X.year>=1970&&X.tourism>30)for(let e=0;e<9;e+=1){let t=new On;t.position.set(-46+e*5.4,.18,7.8+e%2*1.4),t.rotation.y=-.08,t.add(Z(1.9,.12,1.2,`#f8fafc`,0,1.4,0,`sail`,.72)),t.add(Z(1.65,.72,.9,[`#ef4444`,`#14b8a6`,`#f59e0b`][e%3],0,.52,0,`wood`,.72)),Yd.add(t)}if(X.year>=1930)for(let e=0;e<12;e+=1){let t=new On;t.position.set(-58+e*10.5,.18,12.4+e%2*2.2),t.add(Z(.08,2.1,.08,`#1f2937`,0,1.05,0,`metal`,.4)),t.add(Z(.42,.18,.42,`#fde68a`,0,2.18,0,`glass`,.22)),Yd.add(t)}}function op(){let e=Vp(Math.round(Bp(X.year,200,1990)*22+Bp(X.year,900,1990)*42+Bp(X.year,1750,1990)*38+Bp(X.year,1930,1990)*46+X.population*.32),0,160),t=[{x:-56,z:13,columns:8,rows:4,spacingX:5,spacingZ:4.1},{x:-12,z:14,columns:9,rows:4,spacingX:4.9,spacingZ:4},{x:34,z:16,columns:8,rows:4,spacingX:5,spacingZ:4.2},{x:-72,z:31,columns:10,rows:3,spacingX:5.3,spacingZ:4.3},{x:-16,z:31,columns:11,rows:3,spacingX:5.1,spacingZ:4.2},{x:42,z:34,columns:9,rows:3,spacingX:5.3,spacingZ:4.3}],n=0,r=0;for(let i of t)for(let t=0;t<i.rows;t+=1)for(let a=0;a<i.columns;a+=1){if(n>=e)return;let o=i.x+a*i.spacingX+($(r)-.5)*.8,s=i.z+t*i.spacingZ+($(r+4)-.5)*.8;if(Tf(o,s)||s<Ef(o)+2.2){r+=1;continue}let c=X.year>=1930,l=X.year>=1965,u=l&&n%9==0?`highrise`:l&&n%5==0?`office`:c&&n%3==0?`apartment`:X.year>=1750&&n%4==0?`warehouse`:X.year>=900&&n%6==0?`market`:X.year<1450?`cottage`:`warehouse`,d=u===`highrise`?11+$(r+2)*15:u===`office`?7+$(r+2)*7:u===`apartment`?4.2+$(r+2)*4.5:u===`warehouse`?2.5+$(r+2)*2.5:2.1+$(r+2)*1.6,f=sp(u,r);Yd.add(Lf({name:`Urban ${u} ${n+1}`,year:X.year,x:o,z:s,w:u===`highrise`?3.8+$(r+3)*2.6:3+$(r+3)*3.2,d:u===`highrise`?3.4+$(r+5)*2.2:2.5+$(r+5)*3.4,h:d,color:f.body,roof:f.roof,rotation:($(r+8)-.5)*.28,kind:u})),n+=1,r+=1}}function sp(e,t){if(e===`highrise`||e===`office`){let e=[`#8fb5c7`,`#9aa9b5`,`#b6c4cf`,`#6f8ea3`];return{body:e[t%e.length],roof:`#1f2937`}}if(e===`apartment`){let e=[`#d6b58a`,`#c4a484`,`#b9afa2`,`#e7c69a`];return{body:e[t%e.length],roof:`#475569`}}if(e===`warehouse`){let e=[`#8a8d86`,`#9d7651`,`#7f8c8d`,`#b08a64`];return{body:e[t%e.length],roof:`#334155`}}let n=[`#c58f65`,`#d6b182`,`#b87f58`,`#e0d3bb`];return{body:n[t%n.length],roof:`#563627`}}function cp(e,t){let n=new On;n.position.set(e,.18,t);for(let e=0;e<3;e+=1){let t=new q(new Ai(.95,.95,1.45,24),Q(e===1?`#b91c1c`:`#cbd5e1`,.4,`metal`,.18));t.rotation.z=Math.PI/2,t.position.set(e*2.15,.95,0),n.add(t)}return n}function lp(e,t,n){for(let r=0;r<n;r+=1){let n=new q(new Oi(1.35,.06,.85),new co({color:`#102a43`,metalness:.15,roughness:.28,emissive:`#0ea5e9`,emissiveIntensity:.05}));n.position.set(e+r%4*1.65,.78,t+Math.floor(r/4)*1.1),n.rotation.x=-.45,n.rotation.y=-.12,Yd.add(n)}}function up(e,t,n){let r=new On;r.position.set(e,.1,t);let i=new q(new Ai(.12*n,.22*n,7.5*n,16),Q(`#e2e8f0`,.38,`metal`,.16));i.position.y=3.75*n,r.add(i);let a=new q(new Xa(.34*n,16,12),Q(`#f8fafc`,.35,`metal`,.16));a.position.set(0,7.72*n,0),r.add(a);let o=new On;o.position.copy(a.position);for(let e=0;e<3;e+=1){let t=new q(new Oi(.18*n,2.45*n,.05*n),Q(`#f8fafc`,.42,`metal`,.12));t.position.y=1.22*n,t.rotation.z=e*Math.PI*2/3,o.add(t)}return $d.push(o),r.add(o),r}function dp(e,t,n){let r=new On;r.position.set(e,.28,t),r.rotation.y=.08,r.add(Z(1.35,.42,.72,n,0,.28,0,`metal`,.42)),r.add(Z(.72,.34,.58,`#bfdbfe`,-.08,.66,-.02,`glass`,.28));for(let e of[-.43,.43])for(let t of[-.3,.3]){let n=new q(new Ai(.14,.14,.08,12),Q(`#111827`,.55,`rubber`));n.rotation.z=Math.PI/2,n.position.set(e,.12,t),r.add(n)}return r}function fp(e,t,n,r){let i=new On;i.position.set(e,t,n);let a=X.storminess/100,o=new co({color:new G().setHSL(.6,.16,.92-a*.42),roughness:.9,transparent:!0,opacity:.72+a*.18});for(let e=0;e<5;e+=1){let t=new q(new Xa((.8+$(e)*.55)*r,16,12),o);t.position.set((e-2)*.88*r,$(e+5)*.45*r,$(e+9)*.38*r),i.add(t)}return i}function pp(e){let t=new Ar;t.setAttribute(`position`,new K([-.46,0,0,0,.12,0,0,.12,0,.46,0,0],3));let n=new On,r=new Si(t,new ui({color:`#f8fafc`,transparent:!0,opacity:.92}));return n.add(r),n.userData.index=e,n}function mp(){let e=[];for(let t=0;t<260;t+=1){let n=-88+$(t)*176,r=-2+$(t+5)*34,i=-72+$(t+9)*98;e.push(n,r,i,n+.45,r-1.5,i+.05)}let t=new Ar;return t.setAttribute(`position`,new K(e,3)),new Si(t,new ui({color:`#b8d7f6`,transparent:!0,opacity:.42}))}function hp(){let e=new On,t=new Vr({color:`#bff7ff`,transparent:!0,opacity:.74,side:2});for(let n=0;n<22;n+=1){let r=new q(new ki(.22+$(n)*.16,12),t);r.position.set(-56+$(n+1)*112,Rp()+.1,-42+$(n+2)*28),r.rotation.x=-Math.PI/2,r.scale.set(1.8,.32,1),e.add(r)}return e}function gp(e,t,n,r,i){let a=new q(new ji(n,r,9),new co({color:i,roughness:.96}));a.position.set(e,r/2-.2,t),a.rotation.y=$(n)*Math.PI,a.receiveShadow=!0,a.castShadow=!0,qd.add(a)}function _p(e,t,n){let r=new On;r.position.set(e,.1,t);let i=new q(new Ai(.12*n,.17*n,.9*n,8),Q(`#6b4423`,.85,`wood`));i.position.y=.45*n,r.add(i);let a=new q(new ji(.72*n,1.8*n,9),Q(`#244f2d`,.92,`grass`));return a.position.y=1.45*n,r.add(a),Up(r),r}function vp(e,t,n,r){for(let i=0;i<4;i+=1){let a=new q(new Xa(.28+i*.08,14,10),new co({color:`#9ca3af`,roughness:1,transparent:!0,opacity:.22}));a.position.set(t+i*.14,n+i*.45,r+i*.06),a.userData.baseY=a.position.y,a.userData.phase=i*.55+$(i),ef.push(a),e.add(a)}}function yp(e,t,n,r){let i=Z(t,.16,.62,r,0,1.58,-n/2-.38);i.rotation.x=-.18,e.add(i)}function Z(e,t,n,r,i,a,o,s=`plaster`,c=.72){let l=new q(new Oi(e,t,n),Q(r,c,s));return l.position.set(i,a,o),l}function Q(e,t,n=`plaster`,r=.03){return new co({color:e,map:bp(n,e),roughness:t,metalness:r})}function bp(e,t){let r=`${e}:${t}`,i=gd.get(r);if(i)return i;let a=document.createElement(`canvas`);a.width=128,a.height=128;let o=a.getContext(`2d`);if(!o)throw Error(`Expected canvas texture context to exist.`);o.fillStyle=t,o.fillRect(0,0,128,128),e===`wood`||e===`hull`?xp(o,128,t,e===`hull`):e===`stone`||e===`concrete`?Sp(o,128,t,e===`concrete`):e===`roof`?Cp(o,128,t):e===`grass`?wp(o,128,t):e===`sand`?Ap(o,128,t,90,.2):e===`road`?Tp(o,128,t):e===`water`?Ep(o,128,t):e===`metal`?Dp(o,128,t):e===`sail`?Op(o,128,t):e===`glass`?kp(o,128,t):Ap(o,128,t,60,.14);let s=new wi(a);return s.colorSpace=Ve,s.wrapS=n,s.wrapT=n,s.repeat.set(e===`water`||e===`grass`?8:2.5,e===`water`||e===`grass`?8:2.5),gd.set(r,s),s}function xp(e,t,n,r){Ap(e,t,n,34,r?.1:.18);for(let i=8;i<t;i+=18)e.fillStyle=jp(n,-.18,r?.22:.34),e.fillRect(0,i,t,2);for(let i=10;i<t;i+=22)e.fillStyle=jp(n,-.25,r?.18:.28),e.fillRect(i,0,2,t);for(let i=0;i<18;i+=1){let a=Math.floor($(i+n.length)*t);e.strokeStyle=jp(n,i%2?-.2:.16,r?.22:.32),e.beginPath(),e.moveTo(0,a),e.bezierCurveTo(t*.22,a-8,t*.72,a+11,t,a-3),e.stroke()}}function Sp(e,t,n,r){Ap(e,t,n,r?32:68,r?.1:.18);let i=r?22:18;e.strokeStyle=jp(n,-.24,r?.22:.34),e.lineWidth=2;for(let n=i;n<t;n+=i)e.beginPath(),e.moveTo(0,n),e.lineTo(t,n),e.stroke();for(let n=0;n<t;n+=i){let r=Math.floor(n/i)%2*i*.55;for(let a=r;a<t;a+=i*1.1)e.beginPath(),e.moveTo(a,n),e.lineTo(a,n+i),e.stroke()}}function Cp(e,t,n){Ap(e,t,n,48,.12);for(let r=0;r<t;r+=16){e.strokeStyle=jp(n,-.28,.34),e.lineWidth=2,e.beginPath(),e.moveTo(0,r),e.lineTo(t,r),e.stroke();for(let n=-8;n<t;n+=16)e.beginPath(),e.arc(n+r/16%2*8,r+12,8,Math.PI,0),e.stroke()}}function wp(e,t,n){Ap(e,t,n,160,.2);for(let r=0;r<80;r+=1){let i=$(r+12)*t,a=$(r+22)*t;e.fillStyle=jp(n,r%2?-.18:.18,.18),e.fillRect(i,a,9+$(r)*18,2)}}function Tp(e,t,n){Ap(e,t,n,95,.22),e.strokeStyle=jp(n,.25,.18),e.lineWidth=3;for(let n=18;n<t;n+=34)e.setLineDash([12,12]),e.beginPath(),e.moveTo(0,n),e.lineTo(t,n),e.stroke();e.setLineDash([])}function Ep(e,t,n){Ap(e,t,n,55,.1);for(let r=8;r<t;r+=12){e.strokeStyle=jp(n,r%3?.32:-.12,.28),e.lineWidth=2,e.beginPath(),e.moveTo(0,r);for(let n=0;n<=t;n+=16)e.quadraticCurveTo(n+8,r+Math.sin(n*.22+r)*4,n+16,r);e.stroke()}}function Dp(e,t,n){Ap(e,t,n,36,.12);for(let r=0;r<t;r+=18)e.fillStyle=jp(n,r%2?-.16:.22,.22),e.fillRect(r,0,3,t)}function Op(e,t,n){Ap(e,t,n,70,.08),e.strokeStyle=jp(n,-.18,.32),e.lineWidth=2;for(let n=18;n<t;n+=24)e.beginPath(),e.moveTo(n,0),e.lineTo(n+10,t),e.stroke();for(let n=24;n<t;n+=28)e.beginPath(),e.moveTo(0,n),e.lineTo(t,n+4),e.stroke()}function kp(e,t,n){e.fillStyle=jp(n,.25,.7),e.fillRect(0,0,t,t),e.fillStyle=`rgba(255, 255, 255, 0.34)`,e.fillRect(16,0,10,t),e.fillRect(68,0,6,t),e.strokeStyle=`rgba(15, 23, 42, 0.32)`,e.lineWidth=2;for(let n=0;n<t;n+=32)e.beginPath(),e.moveTo(n,0),e.lineTo(n,t),e.stroke()}function Ap(e,t,n,r,i){for(let a=0;a<r;a+=1)e.fillStyle=jp(n,a%2==0?.24:-.22,i*(.45+$(a+t)*.55)),e.fillRect($(a+1)*t,$(a+3)*t,1+$(a+5)*3,1+$(a+7)*3)}function jp(e,t,n){let r=new G(e);return r.lerp(new G(t>=0?`#ffffff`:`#000000`),Math.abs(t)),`rgba(${Math.round(r.r*255)}, ${Math.round(r.g*255)}, ${Math.round(r.b*255)}, ${n})`}function Mp(e,t,n,r){let i=new Ar;return i.setAttribute(`position`,new K([-e/2,0,-t/2,e/2,0,-t/2,0,n,-t/2,-e/2,0,t/2,e/2,0,t/2,0,n,t/2],3)),i.setIndex([0,1,2,3,5,4,0,2,5,0,5,3,1,4,5,1,5,2]),i.computeVertexNormals(),new q(i,Q(r,.68,`roof`))}function Np(e,t,n){let r=e/2,i=t,a=n/2,o=new Ar;return o.setAttribute(`position`,new K([-r,0,-a,r,0,-a,r*.72,i,-a*.82,-r*.72,i,-a*.82,-r,0,a*.62,r,0,a*.62,0,i*.82,a],3)),o.setIndex([0,1,2,0,2,3,4,6,5,0,4,5,0,5,1,1,5,6,1,6,2,0,3,6,0,6,4,3,2,6]),o.computeVertexNormals(),o}function Pp(e,t){let n=new Ar;return n.setAttribute(`position`,new K(e.flat(),3)),n.setIndex([0,1,2]),n.computeVertexNormals(),new q(n,new co({color:t,map:bp(`sail`,t),roughness:.82,side:2}))}function Fp(e,t,n){e.moveTo(t,-n)}function Ip(e,t,n){e.lineTo(t,-n)}function Lp(e,t,n,r,i,a,o){e.bezierCurveTo(t,-n,r,-i,a,-o)}function Rp(){return-.22+X.seaLevel*.0046}function zp(e){return e<0?92:e<900?64:e<1750?36:e<1880?15:e<1965?8:4.5}function Bp(e,t,n){let r=Vp((e-t)/(n-t),0,1);return r*r*(3-2*r)}function Vp(e,t,n){return Math.min(n,Math.max(t,e))}function $(e){return(Math.sin(e*91.345+17.23)+1)/2}function Hp(e){let t=document.querySelector(e);if(!t)throw Error(`Expected ${e} to exist.`);return t}function Up(e){e.traverse(e=>{e instanceof q&&(e.castShadow=!0,e.receiveShadow=!0)})}function Wp(e){for(let t of[...e.children])e.remove(t),Gp(t)}function Gp(e){e.traverse(e=>{if(e instanceof q||e instanceof vi){e.geometry.dispose();let t=e.material;Array.isArray(t)?t.forEach(e=>e.dispose()):t.dispose()}})}