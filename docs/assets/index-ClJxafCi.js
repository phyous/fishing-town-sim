...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Us(e,t,n){let r=new Float32Array(ks),i=new V(0,1,0);return new ao({name:`SphericalGaussianBlur`,defines:{n:ks,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ks(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ws(){return new ao({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ks(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Gs(){return new ao({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ks(),fragmentShader:`
	...
	`}var qs=class extends Zt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ci(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var vl={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function yl(e,t){let n=vl[t];return n===void 0?(I(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var bl=new V;function xl(){return U.getLuminanceCoefficients(bl),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${bl.x.toFixed(4)}, ${bl.y.toFixed(4)}, ${bl.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=ul(i,i.VERTEX_SHADER,y),S=ul(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=gl(i,x,`vertex`),n=gl(i,S,`fragment`);L(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},nd=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},rd=new Wo(-1,1,1,-1,0,1),id=new class extends Ar{constructor(){super(),this.setAttribute(`position`,new K([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new K([0,2,0,0,2,0],2))}},ad=class{constructor(e){this._mesh=new q(id,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,rd)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},od=class extends nd{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof ao?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=no.clone(e.uniforms),this.material=new ao({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new ad(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},sd=class extends nd{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},cd=class extends nd{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},ld=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new B);this._width=n.width,this._height=n.height,t=new Zt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:v}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new od(td),this.copyPass.material.blending=0,this.timer=new Zo}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}sd!==void 0&&(r instanceof sd?n=!0:r instanceof cd&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new B);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},ud=class extends nd{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new G}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},dd={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new G(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
		...
		}`},fd=class e extends nd{constructor(e,t=1,n,r){super(),this.strength=t,this.radius=n,this.threshold=r,this.resolution=e===void 0?new B(256,256):new B(e.x,e.y),this.clearColor=new G(0,0,0),this.needsSwap=!1,this.renderTargetsHorizontal=[],this.renderTargetsVertical=[],this.nMips=5;let i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);this.renderTargetBright=new Zt(i,a,{type:v}),this.renderTargetBright.texture.name=`UnrealBloomPass.bright`,this.renderTargetBright.texture.generateMipmaps=!1;for(let e=0;e<this.nMips;e++){let t=new Zt(i,a,{type:v});t.texture.name=`UnrealBloomPass.h`+e,t.texture.generateMipmaps=!1,this.renderTargetsHorizontal.push(t);let n=new Zt(i,a,{type:v});n.texture.name=`UnrealBloomPass.v`+e,n.texture.generateMipmaps=!1,this.renderTargetsVertical.push(n),i=Math.round(i/2),a=Math.round(a/2)}let o=dd;this.highPassUniforms=no.clone(o.uniforms),this.highPassUniforms.luminosityThreshold.value=r,this.highPassUniforms.smoothWidth.value=.01,this.materialHighPassFilter=new ao({uniforms:this.highPassUniforms,vertexShader:o.vertexShader,fragmentShader:o.fragmentShader}),this.separableBlurMaterials=[];let s=[6,10,14,18,22];i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);for(let e=0;e<this.nMips;e++)this.separableBlurMaterials.push(this._getSeparableBlurMaterial(s[e])),this.separableBlurMaterials[e].uniforms.invSize.value=new B(1/i,1/a),i=Math.round(i/2),a=Math.round(a/2);this.compositeMaterial=this._getCompositeMaterial(this.nMips),this.compositeMaterial.uniforms.blurTexture1.value=this.renderTargetsVertical[0].texture,this.compositeMaterial.uniforms.blurTexture2.value=this.renderTargetsVertical[1].texture,this.compositeMaterial.uniforms.blurTexture3.value=this.renderTargetsVertical[2].texture,this.compositeMaterial.uniforms.blurTexture4.value=this.renderTargetsVertical[3].texture,this.compositeMaterial.uniforms.blurTexture5.value=this.renderTargetsVertical[4].texture,this.compositeMaterial.uniforms.bloomStrength.value=t,this.compositeMaterial.uniforms.bloomRadius.value=.1;let c=[1,.8,.6,.4,.2];this.compositeMaterial.uniforms.bloomFactors.value=c,this.bloomTintColors=[new V(1,1,1),new V(1,1,1),new V(1,1,1),new V(1,1,1),new V(1,1,1)],this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,this.copyUniforms=no.clone(td.uniforms),this.blendMaterial=new ao({uniforms:this.copyUniforms,vertexShader:td.vertexShader,fragmentShader:td.fragmentShader,premultipliedAlpha:!0,blending:2,depthTest:!1,depthWrite:!1,transparent:!0}),this._oldClearColor=new G,this._oldClearAlpha=1,this._basic=new Vr,this._fsQuad=new ad(null)}dispose(){for(let e=0;e<this.renderTargetsHorizontal.length;e++)this.renderTargetsHorizontal[e].dispose();for(let e=0;e<this.renderTargetsVertical.length;e++)this.renderTargetsVertical[e].dispose();this.renderTargetBright.dispose();for(let e=0;e<this.separableBlurMaterials.length;e++)this.separableBlurMaterials[e].dispose();this.compositeMaterial.dispose(),this.blendMaterial.dispose(),this._basic.dispose(),this._fsQuad.dispose()}setSize(e,t){let n=Math.round(e/2),r=Math.round(t/2);this.renderTargetBright.setSize(n,r);for(let e=0;e<this.nMips;e++)this.renderTargetsHorizontal[e].setSize(n,r),this.renderTargetsVertical[e].setSize(n,r),this.separableBlurMaterials[e].uniforms.invSize.value=new B(1/n,1/r),n=Math.round(n/2),r=Math.round(r/2)}render(t,n,r,i,a){t.getClearColor(this._oldClearColor),this._oldClearAlpha=t.getClearAlpha();let o=t.autoClear;t.autoClear=!1,t.setClearColor(this.clearColor,0),a&&t.state.buffers.stencil.setTest(!1),this.renderToScreen&&(this._fsQuad.material=this._basic,this._basic.map=r.texture,t.setRenderTarget(null),t.clear(),this._fsQuad.render(t)),this.highPassUniforms.tDiffuse.value=r.texture,this.highPassUniforms.luminosityThreshold.value=this.threshold,this._fsQuad.material=this.materialHighPassFilter,t.setRenderTarget(this.renderTargetBright),t.clear(),this._fsQuad.render(t);let s=this.renderTargetBright;for(let n=0;n<this.nMips;n++)this._fsQuad.material=this.separableBlurMaterials[n],this.separableBlurMaterials[n].uniforms.colorTexture.value=s.texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionX,t.setRenderTarget(this.renderTargetsHorizontal[n]),t.clear(),this._fsQuad.render(t),this.separableBlurMaterials[n].uniforms.colorTexture.value=this.renderTargetsHorizontal[n].texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionY,t.setRenderTarget(this.renderTargetsVertical[n]),t.clear(),this._fsQuad.render(t),s=this.renderTargetsVertical[n];this._fsQuad.material=this.compositeMaterial,this.compositeMaterial.uniforms.bloomStrength.value=this.strength,this.compositeMaterial.uniforms.bloomRadius.value=this.radius,this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,t.setRenderTarget(this.renderTargetsHorizontal[0]),t.clear(),this._fsQuad.render(t),this._fsQuad.material=this.blendMaterial,this.copyUniforms.tDiffuse.value=this.renderTargetsHorizontal[0].texture,a&&t.state.buffers.stencil.setTest(!0),this.renderToScreen?(t.setRenderTarget(null),this._fsQuad.render(t)):(t.setRenderTarget(r),this._fsQuad.render(t)),t.setClearColor(this._oldClearColor,this._oldClearAlpha),t.autoClear=o}_getSeparableBlurMaterial(e){let t=[],n=e/3;for(let r=0;r<e;r++)t.push(.39894*Math.exp(-.5*r*r/(n*n))/n);return new ao({defines:{KERNEL_RADIUS:e},uniforms:{colorTexture:{value:null},invSize:{value:new B(.5,.5)},direction:{value:new B(.5,.5)},gaussianCoefficients:{value:t}},vertexShader:`
				...
				}`})}_getCompositeMaterial(e){return new ao({defines:{NUM_MIPS:e},uniforms:{blurTexture1:{value:null},blurTexture2:{value:null},blurTexture3:{value:null},blurTexture4:{value:null},blurTexture5:{value:null},bloomStrength:{value:1},bloomFactors:{value:null},bloomTintColors:{value:null},bloomRadius:{value:0}},vertexShader:`
				...
				}`})}};fd.BlurDirectionX=new B(1,0),fd.BlurDirectionY=new B(0,1);var pd=-500,md=1990,hd=new Map,X={year:-500,population:46,fishStock:72,storminess:28,seaLevel:20,tourism:18,industry:28},gd=[{from:-500,name:`Ancient Fishery Harbor`,tag:`oar, sail, amphorae`,details:`A Mediterranean-style fishing cove with reed huts, stone fish tanks, drying racks, amphora storage, oared craft, and small sail boats.`,notes:[`fish-sauce vats`,`reed huts`,`oared skiffs`,`amphora sheds`]},{from:200,name:`Late Antique Port`,tag:`stone quay village`,details:`The cove gains a compact stone quay, watch tower, market court, larger nets, and coastal traders that move salted fish.`,notes:[`watch tower`,`stone quay`,`net courtyards`,`coastal galleys`]},{from:900,name:`Medieval Herring Town`,tag:`cogs and fish market`,details:`A walled fishing town grows around a church, guild hall, timber wharves, fish market, and cog-style cargo boats.`,notes:[`market square`,`guild hall`,`cog boats`,`sea wall`]},{from:1450,name:`Age of Sail Port`,tag:`caravels and salt cod`,details:`Long-distance fisheries add salt houses, rope walks, customs buildings, luggers, caravels, and a fortified harbor mouth.`,notes:[`rope walk`,`salt houses`,`customs house`,`caravels`]},{from:1750,name:`Mercantile Fishing Town`,tag:`schooners and warehouses`,details:`Warehouses, lighthouses, auction halls, sail lofts, and schooner fleets turn the fishing village into a regional port.`,notes:[`lighthouse beam`,`sail lofts`,`warehouses`,`schooners`]},{from:1880,name:`Steam Cannery Port`,tag:`rail, smoke, ice`,details:`Steam trawlers, rail connections, canneries, ice factories, cranes, and breakwaters create an industrial waterfront.`,notes:[`steam trawlers`,`cannery stack`,`rail spur`,`ice factory`]},{from:1930,name:`Diesel Industrial Harbor`,tag:`radar and factory trawlers`,details:`Diesel fleets, cold storage, fuel depots, fishmeal plants, radar masts, trucks, and concrete docks push the port into high throughput.`,notes:[`diesel trawlers`,`cold storage`,`fuel depot`,`concrete docks`]},{from:1965,name:`Modern Port Metropolis`,tag:`container edge city`,details:`By the late 20th century, the historic fishing core is surrounded by apartment blocks, offices, hotels, a marina, container cranes, ferries, and factory ships.`,notes:[`container cranes`,`metro skyline`,`factory ships`,`marina`]}],_d=[{key:`year`,label:`Year`,min:pd,max:md,step:1,suffix:``,hint:`Scrub from 500 BC to 1990; early centuries advance faster during playback.`},{key:`population`,label:`Population pressure`,min:20,max:130,step:1,suffix:`%`,hint:`Controls cottage density, harbor demand, and fleet size.`},{key:`fishStock`,label:`Fish stock`,min:5,max:100,step:1,suffix:`%`,hint:`Changes catch, prosperity, visible fish activity, and conservation pressure.`},{key:`storminess`,label:`Storminess`,min:0,max:100,step:1,suffix:`%`,hint:`Builds darker skies, bigger waves, rain, and rougher seas.`},{key:`seaLevel`,label:`Sea level stress`,min:0,max:100,step:1,suffix:`%`,hint:`Raises the harbor, floats boats higher, and triggers defenses.`},{key:`tourism`,label:`Tourism economy`,min:0,max:100,step:1,suffix:`%`,hint:`Adds marina slips, inns, market stalls, and leisure boats.`},{key:`industry`,label:`Fishing industry`,min:0,max:100,step:1,suffix:`%`,hint:`Adds cannery scale, fuel/ice infrastructure, and working vessels.`}],vd=[{name:`Reed fisher hut`,year:-500,x:-18,z:6.5,w:2.5,d:2.2,h:1.45,color:`#b99561`,roof:`#8a6a39`,rotation:-.2,kind:`hut`},{name:`Amphora shed`,year:-480,x:-11,z:4,w:3.6,d:2.4,h:1.8,color:`#c99358`,roof:`#6b4423`,rotation:.15,kind:`warehouse`},{name:`Fish sauce vats`,year:-460,x:-3.8,z:4.6,w:4,d:2.2,h:1.35,color:`#b87945`,roof:`#7c4a2d`,rotation:.06,kind:`industrial`},{name:`Coastal shrine`,year:-420,x:7,z:9,w:2.9,d:3.6,h:2.5,color:`#ddd0b5`,roof:`#a16207`,rotation:.05,kind:`temple`},{name:`Watch tower`,year:200,x:17,z:6.5,w:2.6,d:2.6,h:5.2,color:`#9a8f7f`,roof:`#5b4636`,rotation:-.08,kind:`fort`},{name:`Stone fish market`,year:420,x:-1.5,z:10.2,w:5.2,d:3.2,h:2.4,color:`#c7b89a`,roof:`#7f5539`,rotation:-.05,kind:`market`},{name:`Guild hall`,year:1040,x:9.8,z:11,w:5.5,d:3.8,h:3.8,color:`#b98b63`,roof:`#334155`,rotation:-.1,kind:`market`},{name:`Harbor wall gate`,year:1180,x:-24,z:1,w:4.3,d:3.2,h:4.8,color:`#81796c`,roof:`#3f3f46`,rotation:.12,kind:`fort`},{name:`Rope walk`,year:1480,x:19,z:2.3,w:10.5,d:1.5,h:1.7,color:`#a17c55`,roof:`#5f3d2e`,rotation:-.12,kind:`warehouse`},{name:`Customs fort`,year:1600,x:26,z:-1.3,w:5.4,d:4.8,h:4.3,color:`#8a8174`,roof:`#52525b`,rotation:.22,kind:`fort`},{name:`Harbor master cottage`,year:1740,x:-16,z:7,w:3.5,d:2.8,h:2.3,color:`#b9794f`,roof:`#563627`,rotation:-.18,kind:`cottage`},{name:`Salt fish shed`,year:1740,x:-9,z:3.5,w:4.4,d:2.6,h:1.9,color:`#9d7651`,roof:`#3e3028`,rotation:.16,kind:`industrial`},{name:`Net loft`,year:1755,x:-3,z:5.3,w:3.6,d:2.5,h:2.1,color:`#c49b6b`,roof:`#6d4934`,rotation:.05,kind:`cottage`},{name:`Chapel`,year:1768,x:5.5,z:10,w:3.2,d:5.2,h:3.1,color:`#e0d3bb`,roof:`#4b5460`,rotation:.07,kind:`chapel`},{name:`Customs house`,year:1810,x:12,z:5.8,w:4.4,d:3.2,h:2.8,color:`#d2b48c`,roof:`#41546b`,rotation:-.12,kind:`cottage`},{name:`Stone warehouse`,year:1845,x:-12,z:-.2,w:5.8,d:3.2,h:3.1,color:`#8a8d86`,roof:`#334155`,rotation:.12,kind:`industrial`},{name:`Steam cannery`,year:1880,x:2.5,z:.5,w:7,d:4.2,h:3.6,color:`#8f6d55`,roof:`#6f1d1b`,rotation:0,kind:`industrial`,condition:e=>e.industry>20},{name:`Rail shed`,year:1898,x:12,z:.3,w:8.5,d:3,h:2.8,color:`#5f6c72`,roof:`#263238`,rotation:-.04,kind:`industrial`,condition:e=>e.industry>35},{name:`Ice plant`,year:1920,x:-20,z:1.5,w:5.4,d:3.7,h:3.2,color:`#a7c7d9`,roof:`#2f4f5f`,rotation:.06,kind:`industrial`,condition:e=>e.industry>42},{name:`Fish auction hall`,year:1955,x:7.8,z:-3.4,w:7.6,d:4.8,h:3.5,color:`#c4beb1`,roof:`#45515f`,rotation:0,kind:`industrial`,condition:e=>e.industry>45},{name:`Seafood market`,year:1988,x:-2.5,z:10.7,w:5.4,d:3.2,h:2.8,color:`#df8d5f`,roof:`#2f6f73`,rotation:-.08,kind:`market`,condition:e=>e.tourism>18},{name:`Harbor inn`,year:1975,x:16.5,z:10,w:6,d:4.2,h:5.8,color:`#f0d5a5`,roof:`#9a3412`,rotation:-.18,kind:`hotel`,condition:e=>e.tourism>35},{name:`Marine lab`,year:1984,x:-18,z:11.5,w:5.4,d:3.8,h:3.2,color:`#d9f5f4`,roof:`#0f766e`,rotation:.18,kind:`research`,condition:e=>e.fishStock<55||e.industry>45},{name:`Ship chandlery`,year:1760,x:-30,z:9.8,w:4.6,d:3,h:2.7,color:`#c08a5a`,roof:`#4b5563`,rotation:.12,kind:`market`},{name:`Civic fish exchange`,year:1888,x:26,z:7,w:8.2,d:4.4,h:4.4,color:`#b9afa2`,roof:`#374151`,rotation:-.16,kind:`market`,condition:e=>e.industry>34},{name:`Cold storage block`,year:1936,x:-36,z:2.6,w:8.4,d:5,h:5.2,color:`#b7c5c9`,roof:`#263238`,rotation:.08,kind:`industrial`,condition:e=>e.industry>48},{name:`Waterfront apartments`,year:1968,x:34,z:15.8,w:7.2,d:5.4,h:8.8,color:`#d8c2a3`,roof:`#475569`,rotation:-.1,kind:`apartment`,condition:e=>e.population>58},{name:`Harbor office tower`,year:1978,x:46,z:18.2,w:5.2,d:4.8,h:14.5,color:`#8fb5c7`,roof:`#1f2937`,rotation:.06,kind:`office`,condition:e=>e.population>70||e.industry>58},{name:`Marina hotel`,year:1982,x:-42,z:15.4,w:7.8,d:5.8,h:7.6,color:`#f0d5a5`,roof:`#0f766e`,rotation:.18,kind:`hotel`,condition:e=>e.tourism>46}],yd=[[-38,8.8,-.18],[-33,13.6,.22],[-28,8.2,-.24],[-23,7.3,-.24],[-20,12.5,.22],[-15.5,17.3,-.08],[-13,12.3,-.1],[-7,11.5,.18],[-1,14.1,-.25],[4,18.4,-.18],[7.3,15.1,.14],[13.5,14.7,-.16],[18.8,17.8,.1],[21,9.4,.24],[23.5,3.5,-.06],[29,12.8,.18],[35.5,16.2,-.2],[42,20.5,.14],[-47,17,.08],[-50,25.5,-.16],[-41,28,.22],[-31.5,25,-.12],[-22,23.8,.18],[-9,25.7,-.06],[8,25,.1],[25,25.5,-.18],[39,29.8,.08],[52,28.4,-.12]],bd=[[-124,9],[-106,5],[-92,-2],[-76,-5],[-60,-12],[-45,-9],[-34,-2.8],[-24,-.4],[-16,-8],[-8,-16],[4,-14],[16,-7],[30,-1.2],[44,3],[59,10.5],[78,18],[99,24],[124,28]],xd=document.querySelector(`#app`);if(!xd)throw Error(`Expected #app element to exist.`);xd.innerHTML=`
  <main class="shell">
    ...
    <section class="simulation-grid">
      ...
      <aside class="control-panel" aria-label="Simulation controls">
        ...
        <div class="controls">
          ${_d.map(e=>`
                <label class="control-row" for="slider-${e.key}">
                  <span>
                    <strong>${e.label}</strong>
                    <em>${e.hint}</em>
                  </span>
                  <output id="value-${e.key}"></output>
                  <input
                    id="slider-${e.key}"
                    type="range"
                    min="${e.min}"
...
`;var Sd=pm(`#town-canvas`),Cd=pm(`.viewport-card`),wd=pm(`#play-button`),Td=pm(`#year-readout`),Ed=pm(`#era-tag`),Dd=pm(`#fleet-readout`),Od=pm(`#catch-readout`),kd=pm(`#buildout-readout`),Ad=pm(`#era-card-title`),jd=pm(`#era-details`),Md=pm(`#era-notes`),Nd=new Map,Pd=new Map;for(let e of _d){let t=document.querySelector(`#slider-${e.key}`),n=document.querySelector(`#value-${e.key}`);if(!t||!n)throw Error(`Missing slider UI for ${e.key}.`);Nd.set(e.key,t),Pd.set(e.key,n)}var Fd=new ju({canvas:Sd,antialias:!0,powerPreference:`high-performance`});Fd.setPixelRatio(Math.min(window.devicePixelRatio,2)),Fd.outputColorSpace=He,Fd.toneMapping=4,Fd.toneMappingExposure=1.03,Fd.shadowMap.enabled=!0,Fd.shadowMap.type=2;var Id=new Ln,Ld=new G(`#8cc9e8`);Id.background=Ld,Id.fog=new In(Ld.clone(),62,235);var Rd=new Vo(48,1,.1,400);Rd.position.set(72,48,78);var zd=new ld(Fd),Bd=new ud(Id,Rd),Vd=new fd(new B(1,1),.24,.52,.76);zd.addPass(Bd),zd.addPass(Vd);var Hd=new Hu(Rd,Sd);Hd.enableDamping=!0,Hd.dampingFactor=.06,Hd.minDistance=30,Hd.maxDistance=185,Hd.maxPolarAngle=Math.PI*.47,Hd.target.set(6,2.6,8);var Ud=new ko(`#dff7ff`,`#3e2d22`,1.45),Wd=new Ko(`#ffe2aa`,3.1);Wd.position.set(-30,42,24),Wd.castShadow=!0,Wd.shadow.mapSize.set(2048,2048),Wd.shadow.camera.left=-105,Wd.shadow.camera.right=105,Wd.shadow.camera.top=105,Wd.shadow.camera.bottom=-105,Wd.shadow.camera.near=1,Wd.shadow.camera.far=220;var Gd=new Ko(`#9dc9ff`,.85);Gd.position.set(25,20,-28);var Kd=new Uo(`#dbeafe`,0,170,1.5);Kd.position.set(-8,30,-20),Id.add(Ud,Wd,Gd,Kd);var qd=new W,Jd=new W,Yd=new W,Xd=new W,Zd=new W;Id.add(qd,Jd,Yd,Xd,Zd);var Qd=[],$d=[],ef=[],tf=[],nf=[],rf=[],af=[],of=null,sf=null,cf=Nf(),lf=cf.getAttribute(`position`),uf=Float32Array.from(lf.array),df=new co({color:`#0f7fa4`,map:Gp(`water`,`#0f7fa4`),roughness:.18,metalness:.02,clearcoat:.82,clearcoatRoughness:.16,transmission:.03,transparent:!0,opacity:.9}),ff=new q(cf,df);ff.receiveShadow=!0,qd.add(ff);var pf=Bp();qd.add(pf),If();var mf=!1,hf=X.year,gf=``,_f=0,vf=new Set,yf=new V,bf=new V,xf=new V,Sf=new V,Cf=new V(0,1,0);for(let e of _d){let t=Nd.get(e.key);t.addEventListener(`input`,()=>{X[e.key]=Number(t.value),e.key===`year`&&(hf=X.year),Ef()})}wd.addEventListener(`click`,()=>{mf=!mf,wd.setAttribute(`aria-pressed`,String(mf)),wd.textContent=mf?`⏸ Pause`:`▶ Play`}),window.addEventListener(`resize`,Tf),window.addEventListener(`keydown`,e=>{let t=e.key.toLowerCase();e.metaKey||e.ctrlKey||![`a`,`s`,`d`,`w`,`q`,`e`].includes(t)||(e.preventDefault(),vf.add(t))}),window.addEventListener(`keyup`,e=>{vf.delete(e.key.toLowerCase())}),Tf(),Ef();var wf=new ds;Fd.setAnimationLoop(()=>{let e=Math.min(wf.getDelta(),.04),t=wf.elapsedTime;if(mf){hf+=e*um(hf),hf>md&&(hf=pd);let t=Math.round(hf);t!==X.year&&(X.year=t,Ef())}Wf(t),Gf(t),Kf(t),qf(t,e),Df(e),Hd.update(),zd.render()});function Tf(){let e=Cd.getBoundingClientRect(),t=Math.max(1,Math.floor(e.width)),n=Math.max(1,Math.floor(e.height));Fd.setSize(t,n,!1),zd.setSize(t,n),Vd.setSize(t,n),Rd.aspect=t/n,Rd.updateProjectionMatrix()}function Ef(){X.year=fm(Math.round(X.year),pd,md);let e=_d.map(e=>X[e.key]).join(`|`);Of(),e!==gf&&(gf=e,zf(),Bf(),Vf(),Hf(),Uf())}function Df(e){if(vf.size===0)return;if(Rd.getWorldDirection(yf),yf.y=0,yf.lengthSq()<1e-4?yf.set(0,0,-1):yf.normalize(),bf.crossVectors(yf,Cf).normalize(),xf.set(0,0,0),vf.has(`w`)&&xf.add(yf),vf.has(`s`)&&xf.sub(yf),vf.has(`d`)&&xf.add(bf),vf.has(`a`)&&xf.sub(bf),xf.lengthSq()>0){let t=Math.max(14,Rd.position.distanceTo(Hd.target)*.42)*e;xf.normalize().multiplyScalar(t),Rd.position.add(xf),Hd.target.add(xf)}let t=!!vf.has(`q`)-+!!vf.has(`e`);if(t!==0){let n=t*e*1.25;Sf.copy(Rd.position).sub(Hd.target).applyAxisAngle(Cf,n),Rd.position.copy(Hd.target).add(Sf),Rd.lookAt(Hd.target)}}function Of(){let e=jf(X.year),t=Mf();for(let e of _d){let t=Nd.get(e.key),n=Pd.get(e.key);t.value=String(X[e.key]),n.value=kf(e,X[e.key])}Td.textContent=Af(X.year),Ed.textContent=e.tag,Dd.textContent=`${t.fleet} vessels`,Od.textContent=`${t.catchIndex} kt`,kd.textContent=`${t.buildout}%`,Ad.textContent=e.name,jd.textContent=e.details,Md.innerHTML=e.notes.map(e=>`<li>${e}</li>`).join(``)}function kf(e,t){return e.key===`year`?Af(t):`${Math.round(t)}${e.suffix}`}function Af(e){let t=Math.round(e);return t<0?`${Math.abs(t)} BC`:`${t}`}function jf(e){return[...gd].reverse().find(t=>e>=t.from)??gd[0]}function Mf(){let e=dm(X.year,900,1990),t=dm(X.year,1840,1970),n=dm(X.year,1960,1990),r=fm(Math.round(1+X.population*.07+X.industry*.115+X.fishStock*.045+X.tourism*.035+e*14+t*12+n*10),2,72),i=1-X.storminess*.0045,a=.55+X.fishStock/180,o=fm(Math.round(r*(.22+e*.2+t*.92)*i*a),1,140),s=fm(Math.round(X.seaLevel*.48+X.storminess*.42+Math.max(0,48-X.fishStock)*.26),0,100);return{buildout:fm(Math.round(dm(X.year,pd,md)*38+e*28+t*20+n*16+X.population*.18+X.industry*.18+X.tourism*.08),4,100),catchIndex:o,coastalExposure:s,fleet:r}}function Nf(){let e=[],t=[],n=[],r=-150,i=-128,a=2.4;for(let o=r;o<150;o+=a)for(let s=i;s<34;s+=a){if(!Pf(o+a/2,s+a/2))continue;let c=[[o,0,s],[o+a,0,s],[o+a,0,s+a],[o,0,s],[o+a,0,s+a],[o,0,s+a]];for(let[a,o,s]of c)e.push(a,o,s),t.push(0,1,0),n.push((a-r)/(150-r),(s-i)/(34-i))}let o=new Ar;return o.setAttribute(`position`,new K(e,3)),o.setAttribute(`normal`,new K(t,3)),o.setAttribute(`uv`,new K(n,2)),o}function Pf(e,t){return t<Ff(e)-.35}function Ff(e){for(let t=0;t<bd.length-1;t+=1){let[n,r]=bd[t],[i,a]=bd[t+1];if(e>=n&&e<=i){let t=(e-n)/(i-n);return jt.lerp(r,a,t)}}return e<bd[0][0]?bd[0][1]:bd[bd.length-1][1]}function If(){let e=new ca;om(e,-126,62),sm(e,-126,9),cm(e,-110,6,-100,1,-92,-2),cm(e,-76,-5,-61,-13,-45,-9),cm(e,-34,-2.8,-24,-.4,-16,-8),cm(e,-8,-16,4,-14,16,-7),cm(e,30,-1.2,44,3,59,10.5),cm(e,78,18,99,24,124,28),sm(e,128,64),sm(e,-126,62);let t=new qa(e,18);t.rotateX(-Math.PI/2);let n=new q(t,Q(`#6f8d52`,.92,`grass`,0));n.position.y=.08,n.receiveShadow=!0,qd.add(n),Lf(),Vp(-86,34,16,6.1,`#4f713f`),Vp(-65,47,12,4.8,`#5a7b46`),Vp(-34,31,10,4.2,`#4f713f`),Vp(-23,39,7,2.8,`#5a7b46`),Vp(31,38,11,4.7,`#557844`),Vp(42,28,7,3.1,`#466a39`),Vp(74,41,15,5.8,`#557844`),Vp(98,33,10,3.9,`#466a39`);for(let[e,t,n]of[[-102,18,1.15],[-94,28,.9],[-82,42,1.3],[-72,29,.8],[-58,38,1.05],[-48,25,.9],[-38,13,1.2],[-34,16,.9],[-29,19,1.1],[-21,20,.8],[-13,19,.85],[10,22,1],[15,18,.8],[23,19,1.15],[29,14,.9],[36,18,1.2],[41,13,.75],[-45,8,.8],[54,31,1.1],[68,38,.95],[84,32,1.25],[101,40,.82]])qd.add(Hp(e,t,n))}function Lf(){for(let[e,t,n,r,i]of[[-108,-82,2.2,.45,`#c7ad75`],[-63,-42,1.6,.35,`#d1b982`],[-23,14,2.4,.5,`#d6bd82`],[18,43,1.8,.4,`#cdb57d`],[62,94,2.1,.45,`#d5c08b`]])qd.add(Rf(e,t,n,r,i))}function Rf(e,t,n,r,i){let a=[],o=[];for(let i=0;i<=16;i+=1){let s=i/16,c=jt.lerp(e,t,s),l=Ff(c),u=Math.sin(s*Math.PI*3+e*.04)*.35;a.push([c,l+n+u]),o.push([c,l-r+u*.25])}let s=new ca;om(s,a[0][0],a[0][1]);for(let[e,t]of a.slice(1))sm(s,e,t);for(let[e,t]of[...o].reverse())sm(s,e,t);sm(s,a[0][0],a[0][1]);let c=Q(i,.88,`sand`,0);c.side=2;let l=new q(new qa(s,12),c);return l.rotation.x=-Math.PI/2,l.position.y=.13,l.receiveShadow=!0,l}function zf(){hm(Jd),$d.length=0;let e=lm();bp(e);let t=fm(9+dm(X.year,pd,md)*36+X.industry*.11,9,52);if(Jd.add(sp(-8,-6.8,t,X.year<900?1.15:2.1,-.08,X.year<200?`#9b7651`:`#8b6444`)),X.year>=200&&cp(-11,-2.7,12+dm(X.year,200,1450)*8,2.25,.03,`#8c908a`),X.year>=900&&(Jd.add(sp(4.5,-7.2,t*.72,1.7,.13,`#7a6045`)),cp(8,-2.7,15+dm(X.year,900,1880)*9,2.7,-.04,`#92958d`),xp()),X.year>=1750&&(Jd.add(sp(-20,-8.2,t*.56,1.4,-.35,`#8b6444`)),Jd.add(sp(28,-8.8,t*.5,1.25,.32,`#8b6444`))),X.year>=1880&&(cp(-31,-8.3,30,2.6,-.32,`#9da1a1`),cp(31,-8.6,32,2.6,.32,`#9da1a1`),Sp(-22,-6.1,.95),Sp(18,-6.4,1.05),Sp(38,-7.6,.92)),X.year>=1930&&(cp(4,-15.4,46,3.4,.02,`#a7a9a8`),Sp(3,-12.5,1.18),Sp(-9,-13.2,1.05)),X.year>=1965&&X.industry>42&&Cp(),X.year>=1985&&X.industry>70&&(Jd.add(Mp(-64,-28,1.1)),Jd.add(Mp(63,-30,.95))),X.year>=1970&&X.tourism>34){let e=Math.round(3+X.tourism/14);for(let t=0;t<e;t+=1){let e=9+t*2.25;Jd.add(sp(e,-10.5,7.5,.48,.03,`#c7ad80`)),t%2==0&&Jd.add(sp(-34+t*2.2,-11.8,8.2,.48,-.18,`#c7ad80`))}}fp(e),(Mf().coastalExposure>57||X.year>=1965&&X.seaLevel>55)&&wp(e),mm(Jd)}function Bf(){hm(Yd),Qd.length=0,ef.length=0,nf.length=0,X.year>=200&&Tp(-12,9.2,78,1.15,-.04),X.year>=900&&(Tp(4,15.2,118,.95,.02),Tp(-38,20.2,1,30,.04),Tp(34,20.8,1,28,-.05)),X.year>=1880&&(Tp(4,1.5,72,1.05,.07),Tp(-54,26.4,1.05,31,.08),Tp(58,27.4,1.05,30,-.06)),X.year>=1930&&(Tp(2,24.2,148,1.45,-.03),Tp(-30,13,1.1,39,.03),Tp(30,14,1.1,38,-.06),Tp(0,38.5,132,1.2,.01)),Ep(),Dp();let e=fm(Math.round(3+X.population/13+dm(X.year,-500,1750)*11),X.year<0?3:6,yd.length);for(let t=0;t<e;t+=1){let[e,n,r]=yd[t],i=t%3,a=X.year<900,o=a?[`#b99561`,`#c59f68`,`#a87945`]:[`#c58f65`,`#d6b182`,`#b87f58`],s=a?[`#8a6a39`,`#7c5b32`,`#6b4423`]:[`#654321`,`#74422d`,`#4b5563`];Yd.add(Jf({name:`Fisher cottage ${t+1}`,year:1740,x:e,z:n,w:2.7+t%2*.4,d:2.4,h:2+t%3*.18,color:o[i],roof:s[i],rotation:r,kind:a?`hut`:`cottage`}))}for(let e of vd)X.year<e.year||e.condition&&!e.condition(X)||e.name!==`Lighthouse`&&Yd.add(Jf(e));if(Op(),X.year>=1750&&Yd.add(np(-29,-5.8)),X.year>=1930&&X.industry>48&&Yd.add(Ap(-25,-1.7)),X.year>=1930){let e=fm(Math.round((X.population+X.industry)/18),5,24);for(let t=0;t<e;t+=1){let e=Np(-62+t*5.2,3+t%2*2.2,t%2?`#f59e0b`:`#2563eb`);e.userData.index=t,nf.push(e),Yd.add(e)}}X.year>=1988&&jp(20.5,5.4,X.tourism>45?7:4),mm(Yd)}function Vf(){hm(Xd),tf.length=0;let{fleet:e}=Mf(),t=fm(Math.round(e*.94),X.year<0?5:8,52),n=[[-12,-13,-.08],[-7,-15.8,.12],[-2.5,-12.6,-.22],[4,-15.4,.18],[10,-12.6,-.12],[15,-16.2,.08],[-18,-10.5,.3],[21,-11.5,-.32],[-23,-14.8,.24],[27,-15.3,-.24],[1,-20.3,.04],[-7,-21.4,-.18],[11,-21.8,.18],[-29,-10.7,.45],[31,-10.9,-.45],[-17,-19.9,.14],[21,-20.5,-.12],[0,-9.8,.03],[-38,-18.3,.35],[39,-18.7,-.32],[-33,-26.4,.22],[33,-28.5,-.18],[6,-30.2,.08],[-4,-33.5,-.1],[18,-31.6,.16],[-20,-30.1,-.16],[-51,-28.7,.28],[49,-29.4,-.24],[-62,-38.4,.18],[61,-40.6,-.2],[-43,-48.6,.3],[42,-51.2,-.26],[-12,-44.1,.08],[15,-46.5,-.1],[-72,-21.6,.38],[72,-24.4,-.34]];for(let e=0;e<t;e+=1){let[t,r,i]=n[e%n.length],a=ip(op(e),e);a.position.set(t+$(e)*1.1,lm()+.38,r+$(e+4)*.9),a.rotation.y=i+$(e+8)*.14,a.userData.baseY=a.position.y,a.userData.phase=$(e+14)*Math.PI*2,e%5==0&&(a.userData.route={startX:-48+$(e+21)*18,endX:46-$(e+24)*20,z:-25-$(e+27)*18,speed:.018+$(e+30)*.025}),tf.push(a),Xd.add(a)}let r=fm(Math.round(X.fishStock/5),2,20);pf.visible=X.fishStock>18,pf.children.forEach((e,t)=>{e.visible=t<r}),mm(Xd)}function Hf(){hm(Zd),rf.length=0,af.length=0,of=null,sf=null;let e=fm(Math.round(8+X.storminess/7),8,24);for(let t=0;t<e;t+=1){let n=Pp(-82+164/e*t+$(t)*7,20+$(t+3)*9,-46+$(t+6)*34,.9+$(t+9)*.7);n.userData.speed=.16+$(t+11)*.18,Zd.add(n)}let t=fm(Math.round(7+X.tourism/14-X.storminess/18),2,12);for(let e=0;e<t;e+=1){let t=Lp(e);rf.push(t),Zd.add(t)}if(X.storminess>58&&(of=Rp(),Zd.add(of)),X.storminess>42&&(sf=zp(),Zd.add(sf)),X.storminess>54&&Zd.add(Fp()),X.storminess>64)for(let e=0;e<3;e+=1){let t=Ip(-34+e*28+$(e)*8,-20-$(e+4)*18,18+$(e+8)*9);af.push(t),Zd.add(t)}}function Uf(){let e=X.storminess/100,t=dm(X.year,1965,1990),n=1-dm(X.year,-500,1750);Ld.setHSL(.56-n*.04,.66-e*.26,.66-e*.34),Id.background=Ld,Id.fog=new In(Ld.clone(),82-e*10,255-e*38),Ud.intensity=1.28-e*.18+t*.12,Wd.intensity=3.5-e*1.45,Gd.intensity=.88+e*.42,df.color.setHSL(.54,.72-e*.18,.39-e*.17),df.roughness=.16+e*.42,Vd.strength=.2+t*.12+(1-e)*.03,Fd.toneMappingExposure=1.12-e*.1}function Wf(e){let t=X.storminess/100,n=.16+t*.96,r=lm();for(let i=0;i<lf.count;i+=1){let a=uf[i*3],o=uf[i*3+2],s=r+Math.sin(a*.16+e*(.85+t))*n*.44+Math.cos(o*.18+e*(1.1+t*1.4))*n*.28+Math.sin((a+o)*.07+e*.42)*n*.18+Math.sin(a*.58+o*.34+e*(2.4+t*2.1))*n*t*.12;lf.setY(i,s)}lf.needsUpdate=!0,_f+=1,_f%5==0&&cf.computeVertexNormals()}function Gf(e){let t=X.storminess/100,n=lm();for(let r of tf){let i=r.userData.phase,a=r.userData.route;if(a){let t=(e*a.speed+i*.03)%1;r.position.x=jt.lerp(a.startX,a.endX,t),r.position.z=a.z+Math.sin(t*Math.PI*2+i)*1.2,r.rotation.y=a.startX<a.endX?Math.PI/2:-Math.PI/2}r.position.y=n+.38+Math.sin(e*1.7+i)*(.08+t*.34),r.rotation.z=Math.sin(e*1.25+i)*(.025+t*.075),r.rotation.x=Math.cos(e*1.08+i)*(.018+t*.06)}for(let e of Qd)e.rotation.y+=.012+t*.006;for(let e of $d)e.rotation.z+=.04+t*.06}function Kf(e){for(let t of nf){let n=t.userData.index,r=(e*(.15+n%4*.025)+n*.17)%1;t.position.x=-66+r*132,t.position.z=3+n%2*2.2+Math.sin(e*.6+n)*.15,t.rotation.y=Math.PI/2}}function qf(e,t){let n=X.storminess/100;for(let e of Zd.children)e.userData.speed&&(e.position.x+=e.userData.speed*t*(1+X.storminess/80),e.position.x>92&&(e.position.x=-92));for(let t of rf){let n=t.userData.index,r=16+n%4*5,i=e*(.18+n*.013)+n;t.position.set(Math.cos(i)*r+$(n)*7,9+Math.sin(e*1.7+n)*1.1+n%3,-12+Math.sin(i)*r*.42),t.rotation.y=-i+Math.PI/2,t.rotation.z=Math.sin(e*6+n)*.22}of&&(of.position.y-=t*(22+X.storminess*.2),of.position.x+=t*(1.2+n*5.5),of.position.y<-10&&(of.position.y=18,of.position.x=0)),sf&&(sf.position.y=lm()+.14+Math.sin(e*2.8)*.05,sf.position.x=Math.sin(e*.35)*1.2);let r=X.storminess>64?Math.max(0,Math.sin(e*1.7+1.2))**38+Math.max(0,Math.sin(e*.53+4.8))**80:0,i=r>.015?fm(r*X.storminess*.12,0,8):0;Kd.intensity=i;for(let t of af){t.visible=i>.35&&$(Math.floor(e*2)+t.id)>.22;let n=t.material;n instanceof ui&&(n.opacity=fm(i/6,0,.95))}for(let t of ef){let n=t.userData.phase,r=t.userData.baseY;t.position.y=r+(e*.55+n)%2.6,t.position.x+=Math.sin(e+n)*.0015;let i=t.material;i instanceof so&&(i.opacity=.26-(t.position.y-r)/2.6*.15)}pf.children.forEach((t,n)=>{t.position.y=lm()+.08+Math.sin(e*2+n)*.06,t.rotation.y+=.01+n*8e-4})}function Jf(e){let t=new W;if(t.name=e.name,t.position.set(e.x,.16,e.z),t.rotation.y=e.rotation??0,e.kind===`hut`){let n=new q(new Ai(e.w*.42,e.w*.5,e.h,10),Q(e.color,.86,`wood`));n.position.y=e.h/2;let r=new q(new ji(e.w*.62,e.h*.85,10),Q(e.roof,.92,`roof`));return r.position.y=e.h+e.h*.36,t.add(n,r),Xf(t,e),t}let n=Yf(e),r=Z(e.w,e.h,e.d,e.color,0,e.h/2,0,n),i=e.kind===`cottage`||e.kind===`market`||e.kind===`hotel`?`stone`:`concrete`;t.add(Z(e.w+.36,.28,e.d+.36,`#6b6f68`,0,.13,0,i,.86),r);let a=e.kind===`industrial`||e.kind===`research`||e.kind===`warehouse`||e.kind===`apartment`||e.kind===`office`||e.kind===`highrise`||e.kind===`port`||e.kind===`fort`;if(a)t.add(Z(e.w+.35,.34,e.d+.35,e.roof,0,e.h+.17,0,`roof`,.68));else{let n=rm(e.w+.55,e.d+.62,.9,e.roof);n.position.y=e.h,t.add(n)}if(Zf(t,e,a),ep(t,e),t.add(Z(.58,.92,.08,`#3d281d`,0,.58,-e.d/2-.055,`wood`,.76)),e.kind===`chapel`||e.kind===`temple`){t.add(Z(1.05,2.6,1,e.color,0,e.h+1.25,-e.d*.34,n));let r=new q(new ji(.72,e.kind===`temple`?.9:1.45,e.kind===`temple`?6:4),Q(e.kind===`temple`?`#a16207`:`#4b5460`,.82,`roof`));r.position.set(0,e.h+3.25,-e.d*.34),r.rotation.y=Math.PI/4,t.add(r)}if(e.kind===`fort`)for(let n of[-e.w/2+.42,e.w/2-.42]){let r=new q(new Ai(.48,.56,e.h*1.18,12),Q(e.color,.88,`stone`));r.position.set(n,e.h*1.18/2,-e.d/2+.35),t.add(r)}if(e.kind===`industrial`){let n=e.h+2.5,r=new q(new Ai(.34,.44,n,14),Q(`#3f332d`,.88,`stone`));r.position.set(e.w*.34,n/2,e.d*.16),t.add(r),X.year>=1880&&X.industry>28&&Up(t,r.position.x,n+.8,r.position.z),t.add(Z(e.w*.78,.12,.14,`#f1f5d8`,0,e.h*.58,-e.d/2-.07,`metal`,.42)),Qf(t,e)}if(e.kind===`market`&&(t.add(Z(e.w*.82,.34,.12,`#fef3c7`,0,e.h*.72,-e.d/2-.09,`wood`,.62)),Wp(t,e.w,e.d,`#e11d48`)),e.kind===`hotel`&&(t.add(Z(e.w*.68,.2,.16,`#fff7ed`,0,e.h*.3,-e.d/2-.1,`metal`,.4)),Wp(t,e.w*.75,e.d,`#0f766e`)),e.kind===`research`){let n=new q(new Ya(1.05,20,12,0,Math.PI*2,0,Math.PI/2),new so({color:`#a7f3d0`,roughness:.18,metalness:.02,transparent:!0,opacity:.72}));n.position.set(-e.w*.24,e.h+.15,0),t.add(n)}if(e.kind===`highrise`||e.kind===`office`){$f(t,e);let n=new q(new Ai(.045,.065,2.1,8),Q(`#cbd5e1`,.35,`metal`,.2));n.position.set(e.w*.25,e.h+1.2,e.d*.2),t.add(n)}return t}function Yf(e){return e.kind===`industrial`||e.kind===`warehouse`||e.kind===`port`?X.year>=1880?`concrete`:`stone`:e.kind===`fort`||e.kind===`chapel`||e.kind===`temple`?`stone`:e.kind===`office`||e.kind===`highrise`||e.kind===`research`?`glass`:e.kind===`apartment`?`plaster`:X.year<900?`wood`:`plaster`}function Xf(e,t){e.add(Z(.5,.76,.08,`#4a2f1b`,0,.46,-t.w*.43,`wood`,.8));for(let n=0;n<3;n+=1){let r=new q(new Xa(t.w*(.42+n*.025),.025,6,18),Q(`#d5b174`,.85,`wood`));r.position.y=.42+n*.38,r.rotation.x=Math.PI/2,e.add(r)}for(let n=0;n<8;n+=1){let r=n/8*Math.PI*2,i=Z(.045,t.h*.86,.045,`#6b4423`,Math.cos(r)*t.w*.45,t.h*.46,Math.sin(r)*t.w*.45,`wood`,.86);i.rotation.y=r,e.add(i)}}function Zf(e,t,n){let r=t.kind===`office`||t.kind===`highrise`?`#dbeafe`:t.kind===`industrial`||t.kind===`warehouse`?`#475569`:`#f8e6c2`,i=t.kind===`office`||t.kind===`highrise`?`metal`:`wood`;if(e.add(Z(t.w+.18,.12,.14,r,0,.42,-t.d/2-.08,i,.55)),n)e.add(Z(t.w+.55,.16,.18,r,0,t.h+.48,-t.d/2-.1,i,.5)),e.add(Z(.18,.16,t.d+.55,r,-t.w/2-.1,t.h+.48,0,i,.5)),e.add(Z(.18,.16,t.d+.55,r,t.w/2+.1,t.h+.48,0,i,.5));else{let n=Z(.16,.18,t.d+.72,r,0,t.h+.9,0,i,.55);n.rotation.z=Math.PI/4,e.add(n),(t.kind===`cottage`||t.kind===`hotel`||t.kind===`market`)&&e.add(Z(.42,1.05,.42,`#5b3a24`,t.w*.24,t.h+.54,t.d*.12,`stone`,.78))}if(t.kind===`cottage`||t.kind===`market`||t.kind===`hotel`){let n=t.kind===`market`?`#16a34a`:`#2f6f3e`;e.add(Z(.82,.22,.22,n,-t.w*.32,.42,-t.d/2-.14,`wood`,.78)),e.add(Z(.82,.22,.22,n,t.w*.32,.42,-t.d/2-.14,`wood`,.78))}}function Qf(e,t){e.add(Z(t.w*.42,.72,.16,`#334155`,-t.w*.24,.64,-t.d/2-.12,`metal`,.42)),e.add(Z(t.w*.56,.16,.72,`#64748b`,-t.w*.12,.28,-t.d/2-.42,`metal`,.48));for(let n=0;n<3;n+=1){let r=new q(new Ai(.22,.28,.32,12),Q(`#94a3b8`,.45,`metal`,.18));r.position.set(-t.w*.28+n*.7,t.h+.58,t.d*.12),e.add(r)}for(let n=0;n<2;n+=1){let r=new q(new Ai(.065,.065,t.h*.8,8),Q(`#475569`,.5,`metal`,.22));r.position.set(-t.w/2-.08,t.h*.44,-t.d*.2+n*t.d*.32),e.add(r)}}function $f(e,t){let n=t.h+.72;e.add(Z(t.w*.36,.45,t.d*.28,`#cbd5e1`,-t.w*.18,n,0,`metal`,.38)),e.add(Z(t.w*.22,.3,t.d*.2,`#64748b`,t.w*.24,n-.06,t.d*.18,`metal`,.4));let r=Math.min(5,Math.floor(t.h/2.2));for(let n=0;n<r;n+=1){let r=1.45+n*1.55;e.add(Z(t.w*.78,.08,.26,`#dbeafe`,0,r,-t.d/2-.18,`metal`,.34))}}function ep(e,t){let n=t.kind===`highrise`?Math.max(6,Math.floor(t.h/1.15)):t.kind===`office`||t.kind===`apartment`||t.kind===`hotel`?Math.max(3,Math.floor(t.h/1.25)):t.h>3?2:1,r=Math.max(2,Math.floor(t.w/(t.kind===`highrise`?.9:1.35))),i=new so({color:`#ffd98a`,map:Gp(`glass`,`#9bdcf4`),emissive:`#ffb84d`,emissiveIntensity:.18+X.storminess/350,roughness:.35}),a=Q(`#1f2937`,.52,`metal`,.12),o=Math.max(2,Math.floor(t.d/1.25));for(let s=0;s<n;s+=1)for(let c=0;c<r;c+=1){if(t.kind===`industrial`&&(c+s)%2==0)continue;let l=-t.w*.36+c*(t.w*.72/Math.max(1,r-1)),u=.95+s*(t.h/(n+.7)),d=new q(new Oi(.42,.48,.045),i);if(d.position.set(l,u,-t.d/2-.045),e.add(d),e.add(tp(.52,.58,a,l,u,-t.d/2-.075,!1)),t.kind===`highrise`||t.kind===`office`){let n=-t.d*.32+c%o*(t.d*.64/Math.max(1,o-1)),r=new q(new Oi(.045,.42,.42),i);r.position.set(t.w/2+.045,u,n),e.add(r)}}}function tp(e,t,n,r,i,a,o){let s=new W,c=o?new Oi(.04,.045,e):new Oi(e,.045,.04),l=o?new Oi(.04,t,.045):new Oi(.045,t,.04),u=new q(c,n),d=new q(c,n),f=new q(l,n),p=new q(l,n);return u.position.y=t/2,d.position.y=-t/2,o?(f.position.z=-e/2,p.position.z=e/2):(f.position.x=-e/2,p.position.x=e/2),s.position.set(r,i,a),s.add(u,d,f,p),s}function np(e,t){let n=new W;n.name=`Lighthouse`,n.position.set(e,.2,t);for(let e=0;e<6;e+=1){let t=new q(new Ai(.78-e*.045,.9-e*.045,.82,20),Q(e%2==0?`#f8fafc`:`#b91c1c`,.78));t.position.y=.42+e*.82,n.add(t)}let r=new q(new Ai(.95,.95,.6,18),Q(`#263238`,.45));r.position.y=5.45,n.add(r);let i=new Uo(`#ffd166`,1.8,36,1.6);i.position.set(0,5.5,0),n.add(i);let a=new Vr({color:`#ffe8a3`,transparent:!0,opacity:.18,depthWrite:!1,side:2}),o=new q(new ji(2.4,20,32,1,!0),a);o.position.set(8.7,5.48,0),o.rotation.z=-Math.PI/2,Qd.push(o),n.add(o);let s=new q(new ji(1.15,.9,18),Q(`#991b1b`,.68));return s.position.y=6.2,n.add(s),n}function rp(e,t,n,r,i=0){let a=new q(new Ai(.045*t,.065*t,3.2*t,8),Q(`#3d281d`,.7,`wood`));if(a.position.set(0,1.75*t,i),e.add(a),r===`square`){let r=new q(new Ka(1.55*t,1.45*t),new so({color:n,map:Gp(`sail`,n),roughness:.88,side:2}));r.position.set(0,2.05*t,i-.03),e.add(r);return}let o=r===`lateen`?[[-.62*t,.6*t,i],[.2*t,2.9*t,i],[1.5*t,.9*t,i]]:[[.06*t,.45*t,i],[.06*t,2.8*t,i],[1.35*t,.7*t,i]];e.add(am(o,n))}function ip(e,t){let n=new W;n.name=`${e} boat`;let r=[`#b91c1c`,`#0f766e`,`#1d4ed8`,`#f59e0b`,`#f8fafc`,`#7c3aed`,`#0f172a`],i=r[t%r.length],a=e===`factory`||e===`container`?2.35:e===`ferry`?1.85:e===`trawler`?1.35:e===`steamer`?1.18:e===`yacht`?.9:e===`dugout`?.58:e===`galley`?1:.92,o=new q(im(1.65*a,.75*a,4.3*a),Q(i,.56,`hull`));if(o.position.y=.25*a,n.add(o),e===`dugout`)n.add(Z(.1*a,.08*a,4.2*a,`#3d281d`,-.52*a,.65*a,0,`wood`,.8)),n.add(Z(.1*a,.08*a,4.2*a,`#3d281d`,.52*a,.65*a,0,`wood`,.8));else if(e===`galley`){rp(n,a,`#f7e7bd`,`square`);for(let e=0;e<8;e+=1){let t=Z(.08*a,.04*a,1.7*a,`#5b3a24`,-.86*a,.55*a,-1.6*a+e*.45*a,`wood`,.78),r=Z(.08*a,.04*a,1.7*a,`#5b3a24`,.86*a,.55*a,-1.6*a+e*.45*a,`wood`,.78);t.rotation.z=.8,r.rotation.z=-.8,n.add(t,r)}}else if(e===`cog`||e===`caravel`||e===`lugger`||e===`schooner`)rp(n,a,e===`cog`?`#f4deb3`:`#f8fafc`,e===`cog`?`square`:`lateen`),(e===`caravel`||e===`schooner`)&&rp(n,a*.82,`#fff7ed`,`triangle`,-.95*a);else if(e===`sail`){let e=new q(new Ai(.045,.06,3.1*a,8),Q(`#4b3427`,.7,`wood`));e.position.y=1.78*a,n.add(e);let t=am([[.08,.5,0],[.08,2.8*a,0],[1.45*a,.75,0]],`#f7f0dc`);t.position.z=-.18,n.add(t)}else{let i=e===`yacht`||e===`ferry`?`#ffffff`:`#e2e8f0`;if(n.add(Z((e===`factory`||e===`container`?1.55:1.05)*a,.8*a,1.05*a,i,0,.88*a,-.38*a,`metal`,.38)),e!==`yacht`&&e!==`ferry`){let e=new q(new Oi(.12,.12,3.4*a),Q(`#2f2a24`,.7,`metal`));e.position.set(.72*a,1.32*a,.56*a),e.rotation.x=-.35,n.add(e),n.add(Z(.95*a,.08*a,1.55*a,`#64748b`,-.75*a,.82*a,.65*a,`metal`,.46))}if(e===`factory`||e===`container`)for(let e=0;e<7;e+=1)n.add(Z(.62*a,.34*a,.48*a,r[(t+e+2)%r.length],-1.2*a+e*.4*a,1.12*a,.62*a,`metal`,.48));e===`ferry`&&(n.add(Z(1.4*a,.35*a,2.8*a,`#dbeafe`,0,1.32*a,.15*a,`glass`,.28)),n.add(Z(1.55*a,.14*a,3.15*a,`#1e3a8a`,0,.82*a,.15*a,`metal`,.42)))}if(e===`steamer`||e===`factory`||e===`ferry`){let e=new q(new Ai(.15,.18,.95*a,10),Q(`#2f2a24`,.65,`metal`));e.position.set(.45*a,1.35*a,-.62*a),n.add(e)}return ap(n,e,a,t,i),n}function ap(e,t,n,r,i){let a=t===`factory`||t===`container`?5.8:t===`ferry`?4.9:3.35,o=t===`factory`||t===`container`?1.85:t===`ferry`?1.6:1.18;e.add(Z(o*n,.08*n,a*n,`#b98b5f`,0,.74*n,-.08*n,`wood`,.74)),e.add(Z(o*n,.08*n,.16*n,i,0,.86*n,-a*.48*n,`hull`,.52));for(let t of[-1,1]){e.add(Z(.055*n,.16*n,a*.78*n,`#f8fafc`,t*o*.53*n,1*n,-.1*n,`metal`,.36));for(let r=0;r<4;r+=1)e.add(Z(.055*n,.36*n,.055*n,`#cbd5e1`,t*o*.53*n,.88*n,(-a*.35+r*a*.23)*n,`metal`,.38))}if(t!==`dugout`&&t!==`galley`&&t!==`cog`&&t!==`caravel`&&t!==`lugger`&&t!==`schooner`&&t!==`sail`)for(let t=0;t<3;t+=1)e.add(Z(.22*n,.22*n,.035*n,`#9bdcf4`,(-.32+t*.32)*n,1.05*n,-.92*n,`glass`,.2));if(t===`trawler`||t===`steamer`||t===`factory`){let t=new q(new Xa(.34*n,.045*n,8,18),Q(`#7c4a2d`,.72,`wood`));t.position.set(-.58*n,1.02*n,.72*n),t.rotation.y=Math.PI/2,e.add(t),e.add(Z(1.05*n,.035*n,.62*n,`#1f2937`,-.72*n,.98*n,.9*n,`rubber`,.78))}if(t===`container`||t===`factory`){e.add(Z(.13*n,1.08*n,.13*n,`#fbbf24`,1.02*n,1.64*n,.25*n,`metal`,.34));let t=Z(2.2*n,.09*n,.09*n,`#f59e0b`,.22*n,2.15*n,.25*n,`metal`,.34);t.rotation.z=-.18,e.add(t)}if(t===`cog`||t===`caravel`||t===`lugger`||t===`schooner`||t===`sail`||t===`galley`){let t=new Ar;t.setAttribute(`position`,new K([0,2.95*n,0,-.72*n,.82*n,-1.72*n,0,2.95*n,0,.72*n,.82*n,1.62*n,0,2.5*n,0,0,.82*n,-1.92*n],3)),e.add(new Si(t,new ui({color:`#2f241f`,transparent:!0,opacity:.72})))}r%3==0&&e.add(Z(.54*n,.22*n,.28*n,`#fef3c7`,-.4*n,.9*n,.2*n,`wood`,.68))}function op(e){return X.year<0?e%3==0?`galley`:`dugout`:X.year<900?e%3==0?`galley`:`lugger`:X.year<1450?e%4==0?`cog`:`lugger`:X.year<1750?e%4==0?`caravel`:`lugger`:X.year<1880?e%3==0?`schooner`:`lugger`:X.year<1930?e%3==0?`steamer`:`schooner`:X.year>=1965&&X.industry>55&&e%8==0?e%16==0?`container`:`factory`:X.year>=1965&&X.tourism>45&&e%6==0?`ferry`:X.year>=1970&&X.tourism>42&&e%4==0?`yacht`:e%5==0&&X.year<1960?`steamer`:`trawler`}function sp(e,t,n,r,i,a){let o=new W;o.position.set(e,0,t),o.rotation.y=i,o.add(Z(r,.25,n,a,0,.36,-n/2,`wood`,.72));for(let e=1;e<n;e+=1.35)o.add(Z(r+.12,.035,.055,`#d1a36f`,0,.51,-e,`wood`,.78));let s=Q(`#4b3427`,.7,`wood`);for(let e=0;e<Math.floor(n/2.4);e+=1)for(let t of[-1,1]){let n=new q(new Ai(.12,.15,1.25,8),s);n.position.set((r/2-.12)*t,-.12,-1.2-e*2.35),o.add(n),e%2==0&&o.add(dp((r/2+.12)*t,.62,-1.2-e*2.35,t<0))}return o}function cp(e,t,n,r,i,a){let o=Z(n,.72,r,a,e,.28,t,`concrete`,.82);o.rotation.y=i,Jd.add(o),lp(e,t,n,r,i)}function lp(e,t,n,r,i){let a=new W;a.position.set(e,0,t),a.rotation.y=i;let o=fm(Math.floor(n/4),3,12);for(let e=0;e<o;e+=1){let t=-n/2+1.4+e*((n-2.8)/Math.max(1,o-1));a.add(up(t,.84,-r/2-.18)),a.add(Z(.22,.76,.28,`#111827`,t,.28,-r/2-.44,`rubber`,.82))}a.add(Z(n*.92,.035,.08,`#fef3c7`,0,.78,-r/2-.04,`metal`,.44)),Jd.add(a)}function up(e,t,n){let r=new W;r.position.set(e,t,n);let i=Q(`#111827`,.5,`metal`,.24),a=new q(new Ai(.13,.16,.38,12),i);a.position.y=.16;let o=new q(new Ai(.22,.18,.1,12),i);return o.position.y=.4,r.add(a,o),r}function dp(e,t,n,r){let i=new W;return i.position.set(e,t,n),i.rotation.y=r?Math.PI:0,i.add(Z(.42,.08,.12,`#111827`,0,.06,0,`metal`,.45)),i.add(Z(.1,.12,.22,`#111827`,-.16,.1,0,`metal`,.45)),i.add(Z(.1,.12,.22,`#111827`,.16,.1,0,`metal`,.45)),i}function fp(e){pp(e),_p(),X.year>=900&&(Jd.add(hp(-55,-7.8,34,2.4,-.62,`#ef4444`)),Jd.add(hp(55,-10.2,38,2.4,.55,`#22c55e`))),X.year>=1750&&vp(e),X.year>=1880&&yp()}function pp(e){for(let[t,n,r]of[[-7,-22,`#ef4444`],[7,-23.5,`#22c55e`],[-12,-39,`#ef4444`],[13,-41,`#22c55e`],[-24,-54,`#f59e0b`],[25,-57,`#f59e0b`]])Jd.add(mp(t,n,r,e))}function mp(e,t,n,r){let i=new W;i.position.set(e,r+.08,t);let a=new q(new Ai(.26,.34,.72,12),Q(n,.46,`metal`,.12));a.position.y=.28;let o=new q(new ji(.25,.42,12),Q(`#f8fafc`,.48,`metal`,.08));o.position.y=.88;let s=new vi(new Ar().setFromPoints([new V(0,.02,0),new V(0,-1.25,0)]),new ui({color:`#1f2937`,transparent:!0,opacity:.45}));return i.add(a,o,s),i}function hp(e,t,n,r,i,a){let o=new W;o.position.set(e,0,t),o.rotation.y=i,o.add(Z(r,.62,n,`#7b8176`,0,.36,-n/2,`stone`,.92)),o.add(Z(r*.42,.18,n*.92,`#4b5563`,0,.78,-n/2,`concrete`,.82));for(let e=0;e<Math.floor(n/2);e+=1)for(let t of[-1,1]){let n=Z(.7+$(e+t*4)*.55,.38+$(e+11)*.28,.62+$(e+19)*.56,`#626b60`,t*(r*.62+$(e+3)*.55),.26,-1.2-e*1.9,`stone`,.96);n.rotation.y=$(e+8)*Math.PI,o.add(n)}return o.add(gp(0,1.02,-n+1.2,a)),o}function gp(e,t,n,r){let i=new W;i.position.set(e,t,n),i.add(new q(new Ai(.22,.28,1.15,12),Q(`#f8fafc`,.5,`metal`,.08)));let a=new q(new Ya(.24,16,10),Q(r,.22,`glass`,.04));a.position.y=.72,i.add(a);let o=new Uo(r,.55,14,1.6);return o.position.y=.72,i.add(o),i}function _p(){for(let[e,t,n,r,i]of[[-17,-4.9,4.2,8.8,-.18],[18,-5.2,4.8,9.6,.16],[-42,-7.2,3.6,7.8,-.34]]){let a=new W;a.position.set(e,.08,t),a.rotation.y=i;let o=Z(n,.16,r,`#9a8f7f`,0,.17,-r/2,`concrete`,.86);o.rotation.x=-.05,a.add(o),a.add(Z(.12,.18,r*.92,`#475569`,-n*.35,.34,-r/2,`metal`,.45)),a.add(Z(.12,.18,r*.92,`#475569`,n*.35,.34,-r/2,`metal`,.45)),Jd.add(a)}}function vp(e){for(let[t,n]of[[-28,-13],[-3,-18],[24,-13.5],[44,-18],[-48,-18.5]]){let r=new W;r.position.set(t,e-.06,n);for(let e of[-.34,0,.34]){let t=new q(new Ai(.18,.22,2.1,10),Q(`#4b3427`,.78,`wood`));t.position.set(e,.82,Math.abs(e)*.6),t.rotation.z=e*.08,r.add(t)}r.add(Z(1.1,.18,.24,`#4b3427`,0,1.88,.2,`wood`,.78)),Jd.add(r)}}function yp(){for(let e=0;e<8;e+=1){let t=new W;t.position.set(-47+e*4.2,.26,-4.8+e%2*1.6),t.rotation.y=-.2,t.add(Z(1.9,.08,.08,`#334155`,0,.9,0,`metal`,.44)),t.add(Z(.08,1.2,.08,`#334155`,-.82,.6,0,`metal`,.44)),t.add(Z(.08,1.2,.08,`#334155`,.82,.6,0,`metal`,.44));let n=new q(new Xa(.42,.055,8,18),Q(`#0f766e`,.72,`rubber`));n.position.y=.45,n.rotation.x=Math.PI/2,t.add(n),Jd.add(t)}for(let e=0;e<10;e+=1){let t=Z(1.3,.22,.86,`#7c4a2d`,24+e%5*2.1,.62,-4.6-Math.floor(e/5)*1.1,`wood`,.78);Jd.add(t)}}function bp(e){let t=new ui({color:`#dffcff`,transparent:!0,opacity:.55}),n=new Vi(bd.map(([t,n])=>new V(t,e+.035,n-.28))),r=new vi(new Ar().setFromPoints(n.getPoints(110)),t);Jd.add(r)}function xp(){for(let e=0;e<bd.length-1;e+=2){let[t,n]=bd[e],[r,i]=bd[e+1],a=Z(Math.hypot(r-t,i-n),.55,.34,`#7c8178`,(t+r)/2,.42,(n+i)/2+.2,`stone`,.86);a.rotation.y=Math.atan2(i-n,r-t),Jd.add(a)}}function Sp(e,t,n){let r=new W;r.position.set(e,.42,t),r.add(Z(.42*n,4.2*n,.42*n,`#f59e0b`,0,2.1*n,0,`metal`,.36));let i=Z(5.8*n,.22*n,.22*n,`#fbbf24`,2.7*n,4.15*n,0,`metal`,.36);i.rotation.z=.14,r.add(i),r.add(Z(.16*n,1.2*n,.16*n,`#111827`,5.1*n,3.45*n,0,`metal`,.44)),Jd.add(r)}function Cp(){cp(38,-19.2,45,5.2,.02,`#9ca3af`);for(let e=0;e<64;e+=1){let t=Math.floor(e/12),n=[`#dc2626`,`#2563eb`,`#f97316`,`#16a34a`,`#eab308`][e%5],r=Z(1.75,.7,.82,n,20+e%12*2.15,.92+(e%3==0?.72:0),-21.4-t*1.15,`metal`,.48);Jd.add(r)}Sp(21,-15.8,1.3),Sp(34,-16.1,1.45),Sp(47,-16.4,1.25),Sp(59,-16.7,1.18)}function wp(e){let t=e>1.1?`#d97706`:`#f59e0b`;for(let e=0;e<9;e+=1){let n=Z(2.1,.34,.32,t,-13+e*3.4,.72,-1.35,`wood`,.7);n.rotation.y=.02,Jd.add(n)}}function Tp(e,t,n,r,i){let a=Z(n,.05,r,`#756b5a`,e,.19,t,`road`,.88);a.rotation.y=i,Yd.add(a)}function Ep(){if(!(X.year>1935&&X.industry>70))for(let e=0;e<4;e+=1){let t=new W;t.position.set(-18+e*2.2,.25,4.1+e%2*1.25),t.rotation.y=-.18,t.add(Z(1.7,.08,.08,`#5b4636`,0,1.2,0,`wood`,.78));for(let e of[-.7,.7])t.add(Z(.08,1.15,.08,`#5b4636`,e,.68,0,`wood`,.78));for(let e=0;e<4;e+=1)t.add(Z(.18,.76,.035,`#e8d5a9`,-.55+e*.36,.72,-.04,`sail`,.88));Yd.add(t)}}function Dp(){let e=X.year<900?8:X.year<1880?16:28;for(let t=0;t<e;t+=1){let e=-34+t%14*5.1+$(t)*.5,n=-1.3+Math.floor(t/14)*2.2+$(t+4)*.4,r=t%4==0?`#7c4a2d`:t%4==1?`#a16207`:t%4==2?`#475569`:`#b45309`;Yd.add(Z(.92,.52,.72,r,e,.48,n,t%4==2?`metal`:`wood`,.74))}let t=X.year>=1750?14:6;for(let e=0;e<t;e+=1){let t=new q(new Ai(.28,.32,.62,12),Q(`#7c4a2d`,.76,`wood`));t.position.set(-22+e*2.4,.52,2.2+e%2*1.4),t.rotation.z=e%3==0?Math.PI/2:0,Yd.add(t)}if(X.year>=1970&&X.tourism>30)for(let e=0;e<9;e+=1){let t=new W;t.position.set(-46+e*5.4,.18,7.8+e%2*1.4),t.rotation.y=-.08,t.add(Z(1.9,.12,1.2,`#f8fafc`,0,1.4,0,`sail`,.72)),t.add(Z(1.65,.72,.9,[`#ef4444`,`#14b8a6`,`#f59e0b`][e%3],0,.52,0,`wood`,.72)),Yd.add(t)}if(X.year>=1930)for(let e=0;e<12;e+=1){let t=new W;t.position.set(-58+e*10.5,.18,12.4+e%2*2.2),t.add(Z(.08,2.1,.08,`#1f2937`,0,1.05,0,`metal`,.4)),t.add(Z(.42,.18,.42,`#fde68a`,0,2.18,0,`glass`,.22)),Yd.add(t)}}function Op(){let e=fm(Math.round(dm(X.year,200,1990)*22+dm(X.year,900,1990)*42+dm(X.year,1750,1990)*38+dm(X.year,1930,1990)*46+X.population*.32),0,160),t=[{x:-56,z:13,columns:8,rows:4,spacingX:5,spacingZ:4.1},{x:-12,z:14,columns:9,rows:4,spacingX:4.9,spacingZ:4},{x:34,z:16,columns:8,rows:4,spacingX:5,spacingZ:4.2},{x:-72,z:31,columns:10,rows:3,spacingX:5.3,spacingZ:4.3},{x:-16,z:31,columns:11,rows:3,spacingX:5.1,spacingZ:4.2},{x:42,z:34,columns:9,rows:3,spacingX:5.3,spacingZ:4.3}],n=0,r=0;for(let i of t)for(let t=0;t<i.rows;t+=1)for(let a=0;a<i.columns;a+=1){if(n>=e)return;let o=i.x+a*i.spacingX+($(r)-.5)*.8,s=i.z+t*i.spacingZ+($(r+4)-.5)*.8;if(Pf(o,s)||s<Ff(o)+2.2){r+=1;continue}let c=X.year>=1930,l=X.year>=1965,u=l&&n%9==0?`highrise`:l&&n%5==0?`office`:c&&n%3==0?`apartment`:X.year>=1750&&n%4==0?`warehouse`:X.year>=900&&n%6==0?`market`:X.year<1450?`cottage`:`warehouse`,d=u===`highrise`?11+$(r+2)*15:u===`office`?7+$(r+2)*7:u===`apartment`?4.2+$(r+2)*4.5:u===`warehouse`?2.5+$(r+2)*2.5:2.1+$(r+2)*1.6,f=kp(u,r);Yd.add(Jf({name:`Urban ${u} ${n+1}`,year:X.year,x:o,z:s,w:u===`highrise`?3.8+$(r+3)*2.6:3+$(r+3)*3.2,d:u===`highrise`?3.4+$(r+5)*2.2:2.5+$(r+5)*3.4,h:d,color:f.body,roof:f.roof,rotation:($(r+8)-.5)*.28,kind:u})),n+=1,r+=1}}function kp(e,t){if(e===`highrise`||e===`office`){let e=[`#8fb5c7`,`#9aa9b5`,`#b6c4cf`,`#6f8ea3`];return{body:e[t%e.length],roof:`#1f2937`}}if(e===`apartment`){let e=[`#d6b58a`,`#c4a484`,`#b9afa2`,`#e7c69a`];return{body:e[t%e.length],roof:`#475569`}}if(e===`warehouse`){let e=[`#8a8d86`,`#9d7651`,`#7f8c8d`,`#b08a64`];return{body:e[t%e.length],roof:`#334155`}}let n=[`#c58f65`,`#d6b182`,`#b87f58`,`#e0d3bb`];return{body:n[t%n.length],roof:`#563627`}}function Ap(e,t){let n=new W;n.position.set(e,.18,t);for(let e=0;e<3;e+=1){let t=new q(new Ai(.95,.95,1.45,24),Q(e===1?`#b91c1c`:`#cbd5e1`,.4,`metal`,.18));t.rotation.z=Math.PI/2,t.position.set(e*2.15,.95,0),n.add(t)}return n}function jp(e,t,n){for(let r=0;r<n;r+=1){let n=new q(new Oi(1.35,.06,.85),new so({color:`#102a43`,metalness:.15,roughness:.28,emissive:`#0ea5e9`,emissiveIntensity:.05}));n.position.set(e+r%4*1.65,.78,t+Math.floor(r/4)*1.1),n.rotation.x=-.45,n.rotation.y=-.12,Yd.add(n)}}function Mp(e,t,n){let r=new W;r.position.set(e,.1,t);let i=new q(new Ai(.12*n,.22*n,7.5*n,16),Q(`#e2e8f0`,.38,`metal`,.16));i.position.y=3.75*n,r.add(i);let a=new q(new Ya(.34*n,16,12),Q(`#f8fafc`,.35,`metal`,.16));a.position.set(0,7.72*n,0),r.add(a);let o=new W;o.position.copy(a.position);for(let e=0;e<3;e+=1){let t=new q(new Oi(.18*n,2.45*n,.05*n),Q(`#f8fafc`,.42,`metal`,.12));t.position.y=1.22*n,t.rotation.z=e*Math.PI*2/3,o.add(t)}return $d.push(o),r.add(o),r}function Np(e,t,n){let r=new W;r.position.set(e,.28,t),r.rotation.y=.08,r.add(Z(1.35,.42,.72,n,0,.28,0,`metal`,.42)),r.add(Z(.72,.34,.58,`#bfdbfe`,-.08,.66,-.02,`glass`,.28));for(let e of[-.43,.43])for(let t of[-.3,.3]){let n=new q(new Ai(.14,.14,.08,12),Q(`#111827`,.55,`rubber`));n.rotation.z=Math.PI/2,n.position.set(e,.12,t),r.add(n)}return r}function Pp(e,t,n,r){let i=new W;i.position.set(e,t,n);let a=X.storminess/100,o=new so({color:new G().setHSL(.6,.18,.92-a*.5),roughness:.9,transparent:!0,opacity:.72+a*.12});for(let e=0;e<5;e+=1){let t=new q(new Ya((.8+$(e)*.55)*r,16,12),o);t.position.set((e-2)*.88*r,$(e+5)*.45*r,$(e+9)*.38*r),a>.55&&(t.scale.y=.68),i.add(t)}return a>.62&&i.add(Z(4.1*r,.16*r,1.1*r,`#263142`,0,-.38*r,0,`plaster`,.95)),i}function Fp(){let e=new W;e.position.set(-10,14.5,-24);let t=new so({color:new G(`#263142`),roughness:.96,transparent:!0,opacity:.82});for(let n=0;n<16;n+=1){let r=new q(new Ya(2.2+$(n)*1.4,18,10),t);r.position.set(-44+n*6.2,$(n+2)*1.5,-4+$(n+6)*8),r.scale.set(1.55,.42,.82),e.add(r)}return e.userData.speed=.08,e}function Ip(e,t,n){let r=[],i=e,a=t,o=n;for(let s=0;s<7;s+=1){let c=i+($(s+e)-.5)*5.4,l=a+($(s+t)-.5)*3.6,u=n-(s+1)/7*(n-2.4);r.push(i,o,a,c,u,l),s===3&&r.push(c,u,l,c+3.4,u-2.2,l+1.6),i=c,o=u,a=l}let s=new Ar;s.setAttribute(`position`,new K(r,3));let c=new Si(s,new ui({color:`#e0f2fe`,transparent:!0,opacity:0}));return c.visible=!1,c}function Lp(e){let t=new Ar;t.setAttribute(`position`,new K([-.46,0,0,0,.12,0,0,.12,0,.46,0,0],3));let n=new W,r=new Si(t,new ui({color:`#f8fafc`,transparent:!0,opacity:.92}));return n.add(r),n.userData.index=e,n}function Rp(){let e=320+Math.round(X.storminess*2.2),t=[];for(let n=0;n<e;n+=1){let e=-88+$(n)*176,r=-2+$(n+5)*34,i=-72+$(n+9)*98;t.push(e,r,i,e+.9+X.storminess*.018,r-2.1,i+.08)}let n=new Ar;return n.setAttribute(`position`,new K(t,3)),new Si(n,new ui({color:`#d7ecff`,transparent:!0,opacity:.36+X.storminess/260}))}function zp(){let e=[],t=90+Math.round(X.storminess*.9);for(let n=0;n<t;n+=1){let t=-74+$(n+2)*148,r=-72+$(n+5)*58;if(!Pf(t,r))continue;let i=.8+$(n+7)*1.8;e.push(t,0,r,t+i,0,r+.18+$(n+12)*.35)}let n=new Ar;return n.setAttribute(`position`,new K(e,3)),new Si(n,new ui({color:`#f8feff`,transparent:!0,opacity:fm(X.storminess/170,.24,.64)}))}function Bp(){let e=new W,t=new Vr({color:`#bff7ff`,transparent:!0,opacity:.74,side:2});for(let n=0;n<22;n+=1){let r=new q(new ki(.22+$(n)*.16,12),t);r.position.set(-56+$(n+1)*112,lm()+.1,-42+$(n+2)*28),r.rotation.x=-Math.PI/2,r.scale.set(1.8,.32,1),e.add(r)}return e}function Vp(e,t,n,r,i){let a=new q(new ji(n,r,9),new so({color:i,roughness:.96}));a.position.set(e,r/2-.2,t),a.rotation.y=$(n)*Math.PI,a.receiveShadow=!0,a.castShadow=!0,qd.add(a)}function Hp(e,t,n){let r=new W;r.position.set(e,.1,t);let i=new q(new Ai(.12*n,.17*n,.9*n,8),Q(`#6b4423`,.85,`wood`));i.position.y=.45*n,r.add(i);let a=new q(new ji(.72*n,1.8*n,9),Q(`#244f2d`,.92,`grass`));return a.position.y=1.45*n,r.add(a),mm(r),r}function Up(e,t,n,r){for(let i=0;i<4;i+=1){let a=new q(new Ya(.28+i*.08,14,10),new so({color:`#9ca3af`,roughness:1,transparent:!0,opacity:.22}));a.position.set(t+i*.14,n+i*.45,r+i*.06),a.userData.baseY=a.position.y,a.userData.phase=i*.55+$(i),ef.push(a),e.add(a)}}function Wp(e,t,n,r){let i=Z(t,.16,.62,r,0,1.58,-n/2-.38);i.rotation.x=-.18,e.add(i)}function Z(e,t,n,r,i,a,o,s=`plaster`,c=.72){let l=new q(new Oi(e,t,n),Q(r,c,s));return l.position.set(i,a,o),l}function Q(e,t,n=`plaster`,r=.03){return new so({color:e,map:Gp(n,e),roughness:t,metalness:r})}function Gp(e,t){let r=`${e}:${t}`,i=hd.get(r);if(i)return i;let a=document.createElement(`canvas`);a.width=128,a.height=128;let o=a.getContext(`2d`);if(!o)throw Error(`Expected canvas texture context to exist.`);o.fillStyle=t,o.fillRect(0,0,128,128),e===`wood`||e===`hull`?Kp(o,128,t,e===`hull`):e===`stone`||e===`concrete`?qp(o,128,t,e===`concrete`):e===`roof`?Jp(o,128,t):e===`grass`?Yp(o,128,t):e===`sand`?tm(o,128,t,90,.2):e===`road`?Xp(o,128,t):e===`water`?Zp(o,128,t):e===`metal`?Qp(o,128,t):e===`sail`?$p(o,128,t):e===`glass`?em(o,128,t):tm(o,128,t,60,.14);let s=new wi(a);return s.colorSpace=He,s.wrapS=n,s.wrapT=n,s.repeat.set(e===`water`||e===`grass`?8:2.5,e===`water`||e===`grass`?8:2.5),hd.set(r,s),s}function Kp(e,t,n,r){tm(e,t,n,34,r?.1:.18);for(let i=8;i<t;i+=18)e.fillStyle=nm(n,-.18,r?.22:.34),e.fillRect(0,i,t,2);for(let i=10;i<t;i+=22)e.fillStyle=nm(n,-.25,r?.18:.28),e.fillRect(i,0,2,t);for(let i=0;i<18;i+=1){let a=Math.floor($(i+n.length)*t);e.strokeStyle=nm(n,i%2?-.2:.16,r?.22:.32),e.beginPath(),e.moveTo(0,a),e.bezierCurveTo(t*.22,a-8,t*.72,a+11,t,a-3),e.stroke()}}function qp(e,t,n,r){tm(e,t,n,r?32:68,r?.1:.18);let i=r?22:18;e.strokeStyle=nm(n,-.24,r?.22:.34),e.lineWidth=2;for(let n=i;n<t;n+=i)e.beginPath(),e.moveTo(0,n),e.lineTo(t,n),e.stroke();for(let n=0;n<t;n+=i){let r=Math.floor(n/i)%2*i*.55;for(let a=r;a<t;a+=i*1.1)e.beginPath(),e.moveTo(a,n),e.lineTo(a,n+i),e.stroke()}}function Jp(e,t,n){tm(e,t,n,48,.12);for(let r=0;r<t;r+=16){e.strokeStyle=nm(n,-.28,.34),e.lineWidth=2,e.beginPath(),e.moveTo(0,r),e.lineTo(t,r),e.stroke();for(let n=-8;n<t;n+=16)e.beginPath(),e.arc(n+r/16%2*8,r+12,8,Math.PI,0),e.stroke()}}function Yp(e,t,n){tm(e,t,n,160,.2);for(let r=0;r<80;r+=1){let i=$(r+12)*t,a=$(r+22)*t;e.fillStyle=nm(n,r%2?-.18:.18,.18),e.fillRect(i,a,9+$(r)*18,2)}}function Xp(e,t,n){tm(e,t,n,95,.22),e.strokeStyle=nm(n,.25,.18),e.lineWidth=3;for(let n=18;n<t;n+=34)e.setLineDash([12,12]),e.beginPath(),e.moveTo(0,n),e.lineTo(t,n),e.stroke();e.setLineDash([])}function Zp(e,t,n){tm(e,t,n,55,.1);for(let r=8;r<t;r+=12){e.strokeStyle=nm(n,r%3?.32:-.12,.28),e.lineWidth=2,e.beginPath(),e.moveTo(0,r);for(let n=0;n<=t;n+=16)e.quadraticCurveTo(n+8,r+Math.sin(n*.22+r)*4,n+16,r);e.stroke()}}function Qp(e,t,n){tm(e,t,n,36,.12);for(let r=0;r<t;r+=18)e.fillStyle=nm(n,r%2?-.16:.22,.22),e.fillRect(r,0,3,t)}function $p(e,t,n){tm(e,t,n,70,.08),e.strokeStyle=nm(n,-.18,.32),e.lineWidth=2;for(let n=18;n<t;n+=24)e.beginPath(),e.moveTo(n,0),e.lineTo(n+10,t),e.stroke();for(let n=24;n<t;n+=28)e.beginPath(),e.moveTo(0,n),e.lineTo(t,n+4),e.stroke()}function em(e,t,n){e.fillStyle=nm(n,.25,.7),e.fillRect(0,0,t,t),e.fillStyle=`rgba(255, 255, 255, 0.34)`,e.fillRect(16,0,10,t),e.fillRect(68,0,6,t),e.strokeStyle=`rgba(15, 23, 42, 0.32)`,e.lineWidth=2;for(let n=0;n<t;n+=32)e.beginPath(),e.moveTo(n,0),e.lineTo(n,t),e.stroke()}function tm(e,t,n,r,i){for(let a=0;a<r;a+=1)e.fillStyle=nm(n,a%2==0?.24:-.22,i*(.45+$(a+t)*.55)),e.fillRect($(a+1)*t,$(a+3)*t,1+$(a+5)*3,1+$(a+7)*3)}function nm(e,t,n){let r=new G(e);return r.lerp(new G(t>=0?`#ffffff`:`#000000`),Math.abs(t)),`rgba(${Math.round(r.r*255)}, ${Math.round(r.g*255)}, ${Math.round(r.b*255)}, ${n})`}function rm(e,t,n,r){let i=new Ar;return i.setAttribute(`position`,new K([-e/2,0,-t/2,e/2,0,-t/2,0,n,-t/2,-e/2,0,t/2,e/2,0,t/2,0,n,t/2],3)),i.setIndex([0,1,2,3,5,4,0,2,5,0,5,3,1,4,5,1,5,2]),i.computeVertexNormals(),new q(i,Q(r,.68,`roof`))}function im(e,t,n){let r=e/2,i=t,a=n/2,o=new Ar;return o.setAttribute(`position`,new K([-r,0,-a,r,0,-a,r*.72,i,-a*.82,-r*.72,i,-a*.82,-r,0,a*.62,r,0,a*.62,0,i*.82,a],3)),o.setIndex([0,1,2,0,2,3,4,6,5,0,4,5,0,5,1,1,5,6,1,6,2,0,3,6,0,6,4,3,2,6]),o.computeVertexNormals(),o}function am(e,t){let n=new Ar;return n.setAttribute(`position`,new K(e.flat(),3)),n.setIndex([0,1,2]),n.computeVertexNormals(),new q(n,new so({color:t,map:Gp(`sail`,t),roughness:.82,side:2}))}function om(e,t,n){e.moveTo(t,-n)}function sm(e,t,n){e.lineTo(t,-n)}function cm(e,t,n,r,i,a,o){e.bezierCurveTo(t,-n,r,-i,a,-o)}function lm(){return-.22+X.seaLevel*.0046}function um(e){return e<0?92:e<900?64:e<1750?36:e<1880?15:e<1965?8:4.5}function dm(e,t,n){let r=fm((e-t)/(n-t),0,1);return r*r*(3-2*r)}function fm(e,t,n){return Math.min(n,Math.max(t,e))}function $(e){return(Math.sin(e*91.345+17.23)+1)/2}function pm(e){let t=document.querySelector(e);if(!t)throw Error(`Expected ${e} to exist.`);return t}function mm(e){e.traverse(e=>{e instanceof q&&(e.castShadow=!0,e.receiveShadow=!0)})}function hm(e){for(let t of[...e.children])e.remove(t),gm(t)}function gm(e){e.traverse(e=>{if(e instanceof q||e instanceof vi){e.geometry.dispose();let t=e.material;Array.isArray(t)?t.forEach(e=>e.dispose()):t.dispose()}})}