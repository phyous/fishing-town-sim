...
- Procedural 3D town, harbor, terrain, shaped ocean, boats, clouds, gulls, rain, lighthouse beam, smoke, cranes, vehicles, container terminal, solar panels, and wind turbines.
...
- Dynamic metrics for fleet size, catch, build-out, and coastal risk.
