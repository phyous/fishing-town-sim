...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vs(e,t,n){let r=new Float32Array(Ds),i=new U(0,1,0);return new ro({name:`SphericalGaussianBlur`,defines:{n:Ds,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ws(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Hs(){return new ro({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ws(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Us(){return new ro({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ws(),fragmentShader:`
	...
	`}var Gs=class extends Yt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Si(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var gl={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function _l(e,t){let n=gl[t];return n===void 0?(R(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var vl=new U;function yl(){return G.getLuminanceCoefficients(vl),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${vl.x.toFixed(4)}, ${vl.y.toFixed(4)}, ${vl.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=cl(i,i.VERTEX_SHADER,y),S=cl(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=ml(i,x,`vertex`),n=ml(i,S,`fragment`);z(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},ed=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},td=new Ho(-1,1,1,-1,0,1),nd=new class extends kr{constructor(){super(),this.setAttribute(`position`,new q([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new q([0,2,0,0,2,0],2))}},rd=class{constructor(e){this._mesh=new J(nd,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,td)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},id=class extends ed{constructor(e,t=`tDiffuse`){super(),this.textureID=t,this.uniforms=null,this.material=null,e instanceof ro?(this.uniforms=e.uniforms,this.material=e):e&&(this.uniforms=eo.clone(e.uniforms),this.material=new ro({name:e.name===void 0?`unspecified`:e.name,defines:Object.assign({},e.defines),uniforms:this.uniforms,vertexShader:e.vertexShader,fragmentShader:e.fragmentShader})),this._fsQuad=new rd(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},ad=class extends ed{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},od=class extends ed{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},sd=class{constructor(e,t){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),t===void 0){let n=e.getSize(new H);this._width=n.width,this._height=n.height,t=new Yt(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:v}),t.texture.name=`EffectComposer.rt1`}else this._width=t.width,this._height=t.height;this.renderTarget1=t,this.renderTarget2=t.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new id($u),this.copyPass.material.blending=0,this.timer=new Yo}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}ad!==void 0&&(r instanceof ad?n=!0:r instanceof od&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new H);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},cd=class extends ed{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new K}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},ld={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new K(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		}`},ud=class e extends ed{constructor(e,t=1,n,r){super(),this.strength=t,this.radius=n,this.threshold=r,this.resolution=e===void 0?new H(256,256):new H(e.x,e.y),this.clearColor=new K(0,0,0),this.needsSwap=!1,this.renderTargetsHorizontal=[],this.renderTargetsVertical=[],this.nMips=5;let i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);this.renderTargetBright=new Yt(i,a,{type:v}),this.renderTargetBright.texture.name=`UnrealBloomPass.bright`,this.renderTargetBright.texture.generateMipmaps=!1;for(let e=0;e<this.nMips;e++){let t=new Yt(i,a,{type:v});t.texture.name=`UnrealBloomPass.h`+e,t.texture.generateMipmaps=!1,this.renderTargetsHorizontal.push(t);let n=new Yt(i,a,{type:v});n.texture.name=`UnrealBloomPass.v`+e,n.texture.generateMipmaps=!1,this.renderTargetsVertical.push(n),i=Math.round(i/2),a=Math.round(a/2)}let o=ld;this.highPassUniforms=eo.clone(o.uniforms),this.highPassUniforms.luminosityThreshold.value=r,this.highPassUniforms.smoothWidth.value=.01,this.materialHighPassFilter=new ro({uniforms:this.highPassUniforms,vertexShader:o.vertexShader,fragmentShader:o.fragmentShader}),this.separableBlurMaterials=[];let s=[6,10,14,18,22];i=Math.round(this.resolution.x/2),a=Math.round(this.resolution.y/2);for(let e=0;e<this.nMips;e++)this.separableBlurMaterials.push(this._getSeparableBlurMaterial(s[e])),this.separableBlurMaterials[e].uniforms.invSize.value=new H(1/i,1/a),i=Math.round(i/2),a=Math.round(a/2);this.compositeMaterial=this._getCompositeMaterial(this.nMips),this.compositeMaterial.uniforms.blurTexture1.value=this.renderTargetsVertical[0].texture,this.compositeMaterial.uniforms.blurTexture2.value=this.renderTargetsVertical[1].texture,this.compositeMaterial.uniforms.blurTexture3.value=this.renderTargetsVertical[2].texture,this.compositeMaterial.uniforms.blurTexture4.value=this.renderTargetsVertical[3].texture,this.compositeMaterial.uniforms.blurTexture5.value=this.renderTargetsVertical[4].texture,this.compositeMaterial.uniforms.bloomStrength.value=t,this.compositeMaterial.uniforms.bloomRadius.value=.1;let c=[1,.8,.6,.4,.2];this.compositeMaterial.uniforms.bloomFactors.value=c,this.bloomTintColors=[new U(1,1,1),new U(1,1,1),new U(1,1,1),new U(1,1,1),new U(1,1,1)],this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,this.copyUniforms=eo.clone($u.uniforms),this.blendMaterial=new ro({uniforms:this.copyUniforms,vertexShader:$u.vertexShader,fragmentShader:$u.fragmentShader,premultipliedAlpha:!0,blending:2,depthTest:!1,depthWrite:!1,transparent:!0}),this._oldClearColor=new K,this._oldClearAlpha=1,this._basic=new Br,this._fsQuad=new rd(null)}dispose(){for(let e=0;e<this.renderTargetsHorizontal.length;e++)this.renderTargetsHorizontal[e].dispose();for(let e=0;e<this.renderTargetsVertical.length;e++)this.renderTargetsVertical[e].dispose();this.renderTargetBright.dispose();for(let e=0;e<this.separableBlurMaterials.length;e++)this.separableBlurMaterials[e].dispose();this.compositeMaterial.dispose(),this.blendMaterial.dispose(),this._basic.dispose(),this._fsQuad.dispose()}setSize(e,t){let n=Math.round(e/2),r=Math.round(t/2);this.renderTargetBright.setSize(n,r);for(let e=0;e<this.nMips;e++)this.renderTargetsHorizontal[e].setSize(n,r),this.renderTargetsVertical[e].setSize(n,r),this.separableBlurMaterials[e].uniforms.invSize.value=new H(1/n,1/r),n=Math.round(n/2),r=Math.round(r/2)}render(t,n,r,i,a){t.getClearColor(this._oldClearColor),this._oldClearAlpha=t.getClearAlpha();let o=t.autoClear;t.autoClear=!1,t.setClearColor(this.clearColor,0),a&&t.state.buffers.stencil.setTest(!1),this.renderToScreen&&(this._fsQuad.material=this._basic,this._basic.map=r.texture,t.setRenderTarget(null),t.clear(),this._fsQuad.render(t)),this.highPassUniforms.tDiffuse.value=r.texture,this.highPassUniforms.luminosityThreshold.value=this.threshold,this._fsQuad.material=this.materialHighPassFilter,t.setRenderTarget(this.renderTargetBright),t.clear(),this._fsQuad.render(t);let s=this.renderTargetBright;for(let n=0;n<this.nMips;n++)this._fsQuad.material=this.separableBlurMaterials[n],this.separableBlurMaterials[n].uniforms.colorTexture.value=s.texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionX,t.setRenderTarget(this.renderTargetsHorizontal[n]),t.clear(),this._fsQuad.render(t),this.separableBlurMaterials[n].uniforms.colorTexture.value=this.renderTargetsHorizontal[n].texture,this.separableBlurMaterials[n].uniforms.direction.value=e.BlurDirectionY,t.setRenderTarget(this.renderTargetsVertical[n]),t.clear(),this._fsQuad.render(t),s=this.renderTargetsVertical[n];this._fsQuad.material=this.compositeMaterial,this.compositeMaterial.uniforms.bloomStrength.value=this.strength,this.compositeMaterial.uniforms.bloomRadius.value=this.radius,this.compositeMaterial.uniforms.bloomTintColors.value=this.bloomTintColors,t.setRenderTarget(this.renderTargetsHorizontal[0]),t.clear(),this._fsQuad.render(t),this._fsQuad.material=this.blendMaterial,this.copyUniforms.tDiffuse.value=this.renderTargetsHorizontal[0].texture,a&&t.state.buffers.stencil.setTest(!0),this.renderToScreen?(t.setRenderTarget(null),this._fsQuad.render(t)):(t.setRenderTarget(r),this._fsQuad.render(t)),t.setClearColor(this._oldClearColor,this._oldClearAlpha),t.autoClear=o}_getSeparableBlurMaterial(e){let t=[],n=e/3;for(let r=0;r<e;r++)t.push(.39894*Math.exp(-.5*r*r/(n*n))/n);return new ro({defines:{KERNEL_RADIUS:e},uniforms:{colorTexture:{value:null},invSize:{value:new H(.5,.5)},direction:{value:new H(.5,.5)},gaussianCoefficients:{value:t}},vertexShader:`
...
`;var yd=xp(`#town-canvas`),bd=xp(`.viewport-card`),xd=xp(`#play-button`),Sd=xp(`#year-readout`),Cd=xp(`#era-tag`),wd=xp(`#era-name`),Td=xp(`#risk-readout`),Ed=xp(`#fleet-readout`),Dd=xp(`#catch-readout`),Od=xp(`#buildout-readout`),kd=xp(`#era-card-title`),Ad=xp(`#era-details`),jd=xp(`#era-notes`),Md=new Map,Nd=new Map;for(let e of md){let t=document.querySelector(`#slider-${e.key}`),n=document.querySelector(`#value-${e.key}`);if(!t||!n)throw Error(`Missing slider UI for ${e.key}.`);Md.set(e.key,t),Nd.set(e.key,n)}var Pd=new ku({canvas:yd,antialias:!0,powerPreference:`high-performance`});Pd.setPixelRatio(Math.min(window.devicePixelRatio,2)),Pd.outputColorSpace=Be,Pd.toneMapping=4,Pd.toneMappingExposure=1.03,Pd.shadowMap.enabled=!0,Pd.shadowMap.type=2;var Fd=new In,Id=new K(`#8cc9e8`);Fd.background=Id,Fd.fog=new Fn(Id.clone(),48,135);var Ld=new zo(48,1,.1,400);Ld.position.set(45,30,47);var Rd=new sd(Pd),zd=new cd(Fd,Ld),Bd=new ud(new H(1,1),.24,.52,.76);Rd.addPass(zd),Rd.addPass(Bd);var Vd=new Bu(Ld,yd);Vd.enableDamping=!0,Vd.dampingFactor=.06,Vd.minDistance=25,Vd.maxDistance=118,Vd.maxPolarAngle=Math.PI*.47,Vd.target.set(3,2.2,3);var Hd=new Do(`#dff7ff`,`#3e2d22`,1.45),Ud=new Wo(`#ffe2aa`,3.1);Ud.position.set(-30,42,24),Ud.castShadow=!0,Ud.shadow.mapSize.set(2048,2048),Ud.shadow.camera.left=-55,Ud.shadow.camera.right=55,Ud.shadow.camera.top=55,Ud.shadow.camera.bottom=-55,Ud.shadow.camera.near=1,Ud.shadow.camera.far=130;var Wd=new Wo(`#9dc9ff`,.85);Wd.position.set(25,20,-28),Fd.add(Hd,Ud,Wd);var Gd=new Dn,Kd=new Dn,qd=new Dn,Jd=new Dn,Yd=new Dn;Fd.add(Gd,Kd,qd,Jd,Yd);var Xd=[],Zd=[],Qd=[],$d=[],ef=[],tf=[],nf=null,rf=Sf(),af=rf.getAttribute(`position`),of=Float32Array.from(af.array),sf=new oo({color:`#0f7fa4`,roughness:.18,metalness:.02,clearcoat:.82,clearcoatRoughness:.16,transmission:.03,transparent:!0,opacity:.9}),cf=new J(rf,sf);cf.receiveShadow=!0,Gd.add(cf);var lf=ap();Gd.add(lf),Tf();var uf=!1,df=Z.year,ff=``,pf=0;for(let e of md){let t=Md.get(e.key);t.addEventListener(`input`,()=>{Z[e.key]=Number(t.value),e.key===`year`&&(df=Z.year),gf()})}xd.addEventListener(`click`,()=>{uf=!uf,xd.setAttribute(`aria-pressed`,String(uf)),xd.textContent=uf?`⏸ Pause`:`▶ Play`}),window.addEventListener(`resize`,hf),hf(),gf();var mf=new ls;Pd.setAnimationLoop(()=>{let e=Math.min(mf.getDelta(),.04),t=mf.elapsedTime;if(uf){df+=e*vp(df),df>fd&&(df=dd);let t=Math.round(df);t!==Z.year&&(Z.year=t,gf())}jf(t),Mf(t),Nf(t),Pf(t,e),Vd.update(),Rd.render()});function hf(){let e=bd.getBoundingClientRect(),t=Math.max(1,Math.floor(e.width)),n=Math.max(1,Math.floor(e.height));Pd.setSize(t,n,!1),Rd.setSize(t,n),Bd.setSize(t,n),Ld.aspect=t/n,Ld.updateProjectionMatrix()}function gf(){Z.year=bp(Math.round(Z.year),dd,fd);let e=md.map(e=>Z[e.key]).join(`|`);_f(),e!==ff&&(ff=e,Ef(),Df(),Of(),kf(),Af())}function _f(){let e=bf(Z.year),t=xf();for(let e of md){let t=Md.get(e.key),n=Nd.get(e.key);t.value=String(Z[e.key]),n.value=vf(e,Z[e.key])}Sd.textContent=yf(Z.year),Cd.textContent=e.tag,wd.textContent=e.name,Td.textContent=`${t.risk}%`,Ed.textContent=`${t.fleet} vessels`,Dd.textContent=`${t.catchIndex} kt`,Od.textContent=`${t.buildout}%`,kd.textContent=e.name,Ad.textContent=e.details,jd.innerHTML=e.notes.map(e=>`<li>${e}</li>`).join(``)}function vf(e,t){return e.key===`year`?yf(t):`${Math.round(t)}${e.suffix}`}function yf(e){let t=Math.round(e);return t<0?`${Math.abs(t)} BC`:`${t}`}function bf(e){return[...pd].reverse().find(t=>e>=t.from)??pd[0]}function xf(){let e=yp(Z.year,900,1990),t=yp(Z.year,1840,1970),n=yp(Z.year,1960,1990),r=bp(Math.round(1+Z.population*.07+Z.industry*.115+Z.fishStock*.045+Z.tourism*.035+e*9+t*8+n*6),2,46),i=1-Z.storminess*.0045,a=.55+Z.fishStock/180,o=bp(Math.round(r*(.22+e*.2+t*.92)*i*a),1,86),s=bp(Math.round(Z.seaLevel*.48+Z.storminess*.42+Math.max(0,48-Z.fishStock)*.26),0,100);return{buildout:bp(Math.round(yp(Z.year,dd,fd)*38+e*28+t*20+n*16+Z.population*.18+Z.industry*.18+Z.tourism*.08),4,100),catchIndex:o,fleet:r,risk:s}}function Sf(){let e=[],t=[],n=[],r=2.1;for(let i=-82;i<82;i+=r)for(let a=-68;a<18;a+=r){if(!Cf(i+r/2,a+r/2))continue;let o=[[i,0,a],[i+r,0,a],[i+r,0,a+r],[i,0,a],[i+r,0,a+r],[i,0,a+r]];for(let[r,i,a]of o)e.push(r,i,a),t.push(0,1,0),n.push((r- -82)/164,(a- -68)/86)}let i=new kr;return i.setAttribute(`position`,new q(e,3)),i.setAttribute(`normal`,new q(t,3)),i.setAttribute(`uv`,new q(n,2)),i}function Cf(e,t){return t<wf(e)-.35}function wf(e){for(let t=0;t<_d.length-1;t+=1){let[n,r]=_d[t],[i,a]=_d[t+1];if(e>=n&&e<=i){let t=(e-n)/(i-n);return kt.lerp(r,a,t)}}return e<_d[0][0]?_d[0][1]:_d[_d.length-1][1]}function Tf(){let e=new oa;mp(e,-52,28),hp(e,-52,-1),gp(e,-44,-8,-36,-10,-27,-5),gp(e,-20,-1.5,-14,-1,-9,-7),gp(e,-4,-13,5,-12,13,-5),gp(e,22,2,33,2,50,15),hp(e,54,30),hp(e,-52,28);let t=new Ka(e,18);t.rotateX(-Math.PI/2);let n=new J(t,new ao({color:`#6f8d52`,roughness:.92,metalness:0}));n.position.y=.08,n.receiveShadow=!0,Gd.add(n);let r=new J(new Ga(15,25,96,1,.18,Math.PI*.74),new ao({color:`#d9c08a`,roughness:.86,side:2}));r.rotation.x=-Math.PI/2,r.rotation.z=.11,r.position.set(-.5,.105,-5.5),r.scale.set(1.45,.58,1),Gd.add(r),op(-34,21,10,4.2,`#4f713f`),op(-23,24,7,2.8,`#5a7b46`),op(31,24,11,4.7,`#557844`),op(42,18,7,3.1,`#466a39`);for(let[e,t,n]of[[-38,13,1.2],[-34,16,.9],[-29,19,1.1],[-21,20,.8],[-13,19,.85],[10,22,1],[15,18,.8],[23,19,1.15],[29,14,.9],[36,18,1.2],[41,13,.75],[-45,8,.8]])Gd.add(sp(e,t,n))}function Ef(){Cp(Kd),Zd.length=0;let e=_p();Uf(e);let t=bp(7+yp(Z.year,dd,fd)*26+Z.industry*.08,7,35);if(Kd.add(Vf(-8,-6.8,t,Z.year<900?1.15:2.1,-.08,Z.year<200?`#9b7651`:`#8b6444`)),Z.year>=200&&Hf(-11,-2.7,12+yp(Z.year,200,1450)*8,2.25,.03,`#8c908a`),Z.year>=900&&(Kd.add(Vf(4.5,-7.2,t*.72,1.7,.13,`#7a6045`)),Hf(8,-2.7,15+yp(Z.year,900,1880)*9,2.7,-.04,`#92958d`),Wf()),Z.year>=1750&&Kd.add(Vf(-20,-8.2,t*.56,1.4,-.35,`#8b6444`)),Z.year>=1880&&(Hf(-23,-7.7,18,2.3,-.36,`#9da1a1`),Hf(23,-8.1,20,2.3,.35,`#9da1a1`),Gf(-16,-6.1,.95),Gf(14,-6.4,1.05)),Z.year>=1930&&(Hf(4,-14,27,3.2,.02,`#a7a9a8`),Gf(3,-12.5,1.18)),Z.year>=1965&&Z.industry>42&&Kf(),Z.year>=1985&&Z.industry>70&&(Kd.add(ep(-34,-13,1.1)),Kd.add(ep(33,-13,.95))),Z.year>=1970&&Z.tourism>34){let e=Math.round(3+Z.tourism/14);for(let t=0;t<e;t+=1){let e=9+t*2.25;Kd.add(Vf(e,-10.5,7.5,.48,.03,`#c7ad80`))}}(xf().risk>57||Z.year>=1965&&Z.seaLevel>55)&&qf(e),Sp(Kd)}function Df(){Cp(qd),Xd.length=0,Qd.length=0,ef.length=0,Z.year>=200&&Jf(-8,8.8,42,1.15,-.04),Z.year>=900&&Jf(2,14.2,52,.9,.02),Z.year>=1880&&Jf(7,1.5,35,1.05,.07),Z.year>=1930&&(Jf(5,21.2,72,1.45,-.03),Jf(-30,11,1.1,27,.03),Jf(30,12,1.1,25,-.06)),Yf();let e=bp(Math.round(1+Z.population/18+yp(Z.year,-500,1750)*5),Z.year<0?1:3,gd.length);for(let t=0;t<e;t+=1){let[e,n,r]=gd[t],i=t%3,a=Z.year<900,o=a?[`#b99561`,`#c59f68`,`#a87945`]:[`#c58f65`,`#d6b182`,`#b87f58`],s=a?[`#8a6a39`,`#7c5b32`,`#6b4423`]:[`#654321`,`#74422d`,`#4b5563`];qd.add(Ff({name:`Fisher cottage ${t+1}`,year:1740,x:e,z:n,w:2.7+t%2*.4,d:2.4,h:2+t%3*.18,color:o[i],roof:s[i],rotation:r,kind:a?`hut`:`cottage`}))}for(let e of hd)Z.year<e.year||e.condition&&!e.condition(Z)||e.name!==`Lighthouse`&&qd.add(Ff(e));if(Xf(),Z.year>=1750&&qd.add(Lf(-29,-5.8)),Z.year>=1930&&Z.industry>48&&qd.add(Qf(-25,-1.7)),Z.year>=1930){let e=bp(Math.round((Z.population+Z.industry)/24),3,14);for(let t=0;t<e;t+=1){let e=tp(-30+t*5.2,3+t%2*2.2,t%2?`#f59e0b`:`#2563eb`);e.userData.index=t,ef.push(e),qd.add(e)}}Z.year>=1988&&$f(20.5,5.4,Z.tourism>45?7:4),Sp(qd)}function Of(){Cp(Jd),$d.length=0;let{fleet:e}=xf(),t=bp(Math.round(e*.82),Z.year<0?3:5,34),n=[[-12,-13,-.08],[-7,-15.8,.12],[-2.5,-12.6,-.22],[4,-15.4,.18],[10,-12.6,-.12],[15,-16.2,.08],[-18,-10.5,.3],[21,-11.5,-.32],[-23,-14.8,.24],[27,-15.3,-.24],[1,-20.3,.04],[-7,-21.4,-.18],[11,-21.8,.18],[-29,-10.7,.45],[31,-10.9,-.45],[-17,-19.9,.14],[21,-20.5,-.12],[0,-9.8,.03],[-38,-18.3,.35],[39,-18.7,-.32],[-33,-26.4,.22],[33,-28.5,-.18],[6,-30.2,.08],[-4,-33.5,-.1],[18,-31.6,.16],[-20,-30.1,-.16]];for(let e=0;e<t;e+=1){let[t,r,i]=n[e%n.length],a=zf(Bf(e),e);a.position.set(t+$(e)*1.1,_p()+.38,r+$(e+4)*.9),a.rotation.y=i+$(e+8)*.14,a.userData.baseY=a.position.y,a.userData.phase=$(e+14)*Math.PI*2,e%5==0&&(a.userData.route={startX:-48+$(e+21)*18,endX:46-$(e+24)*20,z:-25-$(e+27)*18,speed:.018+$(e+30)*.025}),$d.push(a),Jd.add(a)}let r=bp(Math.round(Z.fishStock/8),1,12);lf.visible=Z.fishStock>18,lf.children.forEach((e,t)=>{e.visible=t<r}),Sp(Jd)}function kf(){Cp(Yd),tf.length=0,nf=null;let e=bp(Math.round(5+Z.storminess/8),5,18);for(let t=0;t<e;t+=1){let n=np(-46+92/e*t+$(t)*5,18+$(t+3)*6,-24+$(t+6)*20,.9+$(t+9)*.7);n.userData.speed=.16+$(t+11)*.18,Yd.add(n)}let t=bp(Math.round(7+Z.tourism/14-Z.storminess/18),2,12);for(let e=0;e<t;e+=1){let t=rp(e);tf.push(t),Yd.add(t)}Z.storminess>58&&(nf=ip(),Yd.add(nf))}function Af(){let e=Z.storminess/100,t=yp(Z.year,1965,1990),n=1-yp(Z.year,-500,1750);Id.setHSL(.55-n*.04,.68-e*.36,.66-e*.25),Fd.background=Id,Fd.fog=new Fn(Id.clone(),42-e*12,155-e*50),Hd.intensity=1.25-e*.34+t*.12,Ud.intensity=3.6-e*2.2,Wd.intensity=.82+e*.28,sf.color.setHSL(.53,.72-e*.24,.39-e*.13),sf.roughness=.16+e*.34,Bd.strength=.2+t*.12+(1-e)*.03,Pd.toneMappingExposure=1.12-e*.24}function jf(e){let t=Z.storminess/100,n=.18+t*.72,r=_p();for(let i=0;i<af.count;i+=1){let a=of[i*3],o=of[i*3+2],s=r+Math.sin(a*.16+e*(.85+t))*n*.44+Math.cos(o*.18+e*(1.1+t*1.4))*n*.28+Math.sin((a+o)*.07+e*.42)*n*.18;af.setY(i,s)}af.needsUpdate=!0,pf+=1,pf%5==0&&rf.computeVertexNormals()}function Mf(e){let t=Z.storminess/100,n=_p();for(let r of $d){let i=r.userData.phase,a=r.userData.route;if(a){let t=(e*a.speed+i*.03)%1;r.position.x=kt.lerp(a.startX,a.endX,t),r.position.z=a.z+Math.sin(t*Math.PI*2+i)*1.2,r.rotation.y=a.startX<a.endX?Math.PI/2:-Math.PI/2}r.position.y=n+.38+Math.sin(e*1.7+i)*(.08+t*.34),r.rotation.z=Math.sin(e*1.25+i)*(.025+t*.075),r.rotation.x=Math.cos(e*1.08+i)*(.018+t*.06)}for(let e of Xd)e.rotation.y+=.012+t*.006;for(let e of Zd)e.rotation.z+=.04+t*.06}function Nf(e){for(let t of ef){let n=t.userData.index,r=(e*(.15+n%4*.025)+n*.17)%1;t.position.x=-31+r*62,t.position.z=3+n%2*2.2+Math.sin(e*.6+n)*.15,t.rotation.y=Math.PI/2}}function Pf(e,t){for(let e of Yd.children)e.userData.speed&&(e.position.x+=e.userData.speed*t*(1+Z.storminess/80),e.position.x>55&&(e.position.x=-55));for(let t of tf){let n=t.userData.index,r=16+n%4*5,i=e*(.18+n*.013)+n;t.position.set(Math.cos(i)*r+$(n)*7,9+Math.sin(e*1.7+n)*1.1+n%3,-12+Math.sin(i)*r*.42),t.rotation.y=-i+Math.PI/2,t.rotation.z=Math.sin(e*6+n)*.22}nf&&(nf.position.y-=t*(18+Z.storminess*.14),nf.position.y<-10&&(nf.position.y=16));for(let t of Qd){let n=t.userData.phase,r=t.userData.baseY;t.position.y=r+(e*.55+n)%2.6,t.position.x+=Math.sin(e+n)*.0015;let i=t.material;i instanceof ao&&(i.opacity=.26-(t.position.y-r)/2.6*.15)}lf.children.forEach((t,n)=>{t.position.y=_p()+.08+Math.sin(e*2+n)*.06,t.rotation.y+=.01+n*8e-4})}function Ff(e){let t=new Dn;if(t.name=e.name,t.position.set(e.x,.16,e.z),t.rotation.y=e.rotation??0,e.kind===`hut`){let n=new J(new Oi(e.w*.42,e.w*.5,e.h,10),up(e.color,.86));n.position.y=e.h/2;let r=new J(new ki(e.w*.62,e.h*.85,10),up(e.roof,.92));return r.position.y=e.h+e.h*.36,t.add(n,r),t}let n=Q(e.w,e.h,e.d,e.color,0,e.h/2,0);if(t.add(n),e.kind===`industrial`||e.kind===`research`||e.kind===`warehouse`||e.kind===`apartment`||e.kind===`office`||e.kind===`highrise`||e.kind===`port`||e.kind===`fort`)t.add(Q(e.w+.35,.34,e.d+.35,e.roof,0,e.h+.17,0));else{let n=dp(e.w+.55,e.d+.62,.9,e.roof);n.position.y=e.h,t.add(n)}if(If(t,e),t.add(Q(.58,.92,.08,`#3d281d`,0,.58,-e.d/2-.055)),e.kind===`chapel`||e.kind===`temple`){t.add(Q(1.05,2.6,1,e.color,0,e.h+1.25,-e.d*.34));let n=new J(new ki(.72,e.kind===`temple`?.9:1.45,e.kind===`temple`?6:4),up(e.kind===`temple`?`#a16207`:`#4b5460`,.82));n.position.set(0,e.h+3.25,-e.d*.34),n.rotation.y=Math.PI/4,t.add(n)}if(e.kind===`fort`)for(let n of[-e.w/2+.42,e.w/2-.42]){let r=new J(new Oi(.48,.56,e.h*1.18,12),up(e.color,.88));r.position.set(n,e.h*1.18/2,-e.d/2+.35),t.add(r)}if(e.kind===`industrial`){let n=e.h+2.5,r=new J(new Oi(.34,.44,n,14),up(`#3f332d`,.88));r.position.set(e.w*.34,n/2,e.d*.16),t.add(r),Z.year>=1880&&Z.industry>28&&cp(t,r.position.x,n+.8,r.position.z),t.add(Q(e.w*.78,.12,.14,`#f1f5d8`,0,e.h*.58,-e.d/2-.07))}if(e.kind===`market`&&(t.add(Q(e.w*.82,.34,.12,`#fef3c7`,0,e.h*.72,-e.d/2-.09)),lp(t,e.w,e.d,`#e11d48`)),e.kind===`hotel`&&(t.add(Q(e.w*.68,.2,.16,`#fff7ed`,0,e.h*.3,-e.d/2-.1)),lp(t,e.w*.75,e.d,`#0f766e`)),e.kind===`research`){let n=new J(new Ja(1.05,20,12,0,Math.PI*2,0,Math.PI/2),new ao({color:`#a7f3d0`,roughness:.18,metalness:.02,transparent:!0,opacity:.72}));n.position.set(-e.w*.24,e.h+.15,0),t.add(n)}if(e.kind===`highrise`||e.kind===`office`){let n=new J(new Oi(.045,.065,2.1,8),up(`#cbd5e1`,.35));n.position.set(e.w*.25,e.h+1.2,e.d*.2),t.add(n)}return t}function If(e,t){let n=t.kind===`highrise`?Math.max(6,Math.floor(t.h/1.15)):t.kind===`office`||t.kind===`apartment`||t.kind===`hotel`?Math.max(3,Math.floor(t.h/1.25)):t.h>3?2:1,r=Math.max(2,Math.floor(t.w/(t.kind===`highrise`?.9:1.35))),i=new ao({color:`#ffd98a`,emissive:`#ffb84d`,emissiveIntensity:.18+Z.storminess/350,roughness:.35});for(let a=0;a<n;a+=1)for(let o=0;o<r;o+=1){if(t.kind===`industrial`&&(o+a)%2==0)continue;let s=-t.w*.36+o*(t.w*.72/Math.max(1,r-1)),c=.95+a*(t.h/(n+.7)),l=new J(new Ei(.42,.48,.045),i);if(l.position.set(s,c,-t.d/2-.045),e.add(l),t.kind===`highrise`||t.kind===`office`){let n=new J(new Ei(.045,.42,.42),i);n.position.set(t.w/2+.045,c,-t.d*.28+o*(t.d*.56)/Math.max(1,r-1)),e.add(n)}}}function Lf(e,t){let n=new Dn;n.name=`Lighthouse`,n.position.set(e,.2,t);for(let e=0;e<6;e+=1){let t=new J(new Oi(.78-e*.045,.9-e*.045,.82,20),up(e%2==0?`#f8fafc`:`#b91c1c`,.78));t.position.y=.42+e*.82,n.add(t)}let r=new J(new Oi(.95,.95,.6,18),up(`#263238`,.45));r.position.y=5.45,n.add(r);let i=new Vo(`#ffd166`,1.8,36,1.6);i.position.set(0,5.5,0),n.add(i);let a=new Br({color:`#ffe8a3`,transparent:!0,opacity:.18,depthWrite:!1,side:2}),o=new J(new ki(2.4,20,32,1,!0),a);o.position.set(8.7,5.48,0),o.rotation.z=-Math.PI/2,Xd.push(o),n.add(o);let s=new J(new ki(1.15,.9,18),up(`#991b1b`,.68));return s.position.y=6.2,n.add(s),n}function Rf(e,t,n,r,i=0){let a=new J(new Oi(.045*t,.065*t,3.2*t,8),up(`#3d281d`,.7));if(a.position.set(0,1.75*t,i),e.add(a),r===`square`){let r=new J(new Wa(1.55*t,1.45*t),new ao({color:n,roughness:.88,side:2}));r.position.set(0,2.05*t,i-.03),e.add(r);return}let o=r===`lateen`?[[-.62*t,.6*t,i],[.2*t,2.9*t,i],[1.5*t,.9*t,i]]:[[.06*t,.45*t,i],[.06*t,2.8*t,i],[1.35*t,.7*t,i]];e.add(pp(o,n))}function zf(e,t){let n=new Dn;n.name=`${e} boat`;let r=[`#b91c1c`,`#0f766e`,`#1d4ed8`,`#f59e0b`,`#f8fafc`,`#7c3aed`,`#0f172a`],i=r[t%r.length],a=e===`factory`||e===`container`?2.35:e===`ferry`?1.85:e===`trawler`?1.35:e===`steamer`?1.18:e===`yacht`?.9:e===`dugout`?.58:e===`galley`?1:.92,o=new J(fp(1.65*a,.75*a,4.3*a),up(i,.56));if(o.position.y=.25*a,n.add(o),e===`dugout`)n.add(Q(.1*a,.08*a,4.2*a,`#3d281d`,-.52*a,.65*a,0)),n.add(Q(.1*a,.08*a,4.2*a,`#3d281d`,.52*a,.65*a,0));else if(e===`galley`){Rf(n,a,`#f7e7bd`,`square`);for(let e=0;e<8;e+=1){let t=Q(.08*a,.04*a,1.7*a,`#5b3a24`,-.86*a,.55*a,-1.6*a+e*.45*a),r=Q(.08*a,.04*a,1.7*a,`#5b3a24`,.86*a,.55*a,-1.6*a+e*.45*a);t.rotation.z=.8,r.rotation.z=-.8,n.add(t,r)}}else if(e===`cog`||e===`caravel`||e===`lugger`||e===`schooner`)Rf(n,a,e===`cog`?`#f4deb3`:`#f8fafc`,e===`cog`?`square`:`lateen`),(e===`caravel`||e===`schooner`)&&Rf(n,a*.82,`#fff7ed`,`triangle`,-.95*a);else if(e===`sail`){let e=new J(new Oi(.045,.06,3.1*a,8),up(`#4b3427`,.7));e.position.y=1.78*a,n.add(e);let t=pp([[.08,.5,0],[.08,2.8*a,0],[1.45*a,.75,0]],`#f7f0dc`);t.position.z=-.18,n.add(t)}else{let i=e===`yacht`||e===`ferry`?`#ffffff`:`#e2e8f0`;if(n.add(Q((e===`factory`||e===`container`?1.55:1.05)*a,.8*a,1.05*a,i,0,.88*a,-.38*a)),e!==`yacht`&&e!==`ferry`){let e=new J(new Ei(.12,.12,3.4*a),up(`#2f2a24`,.7));e.position.set(.72*a,1.32*a,.56*a),e.rotation.x=-.35,n.add(e),n.add(Q(.95*a,.08*a,1.55*a,`#64748b`,-.75*a,.82*a,.65*a))}if(e===`factory`||e===`container`)for(let e=0;e<7;e+=1)n.add(Q(.62*a,.34*a,.48*a,r[(t+e+2)%r.length],-1.2*a+e*.4*a,1.12*a,.62*a));e===`ferry`&&(n.add(Q(1.4*a,.35*a,2.8*a,`#dbeafe`,0,1.32*a,.15*a)),n.add(Q(1.55*a,.14*a,3.15*a,`#1e3a8a`,0,.82*a,.15*a)))}if(e===`steamer`||e===`factory`||e===`ferry`){let e=new J(new Oi(.15,.18,.95*a,10),up(`#2f2a24`,.65));e.position.set(.45*a,1.35*a,-.62*a),n.add(e)}return n}function Bf(e){return Z.year<0?e%3==0?`galley`:`dugout`:Z.year<900?e%3==0?`galley`:`lugger`:Z.year<1450?e%4==0?`cog`:`lugger`:Z.year<1750?e%4==0?`caravel`:`lugger`:Z.year<1880?e%3==0?`schooner`:`lugger`:Z.year<1930?e%3==0?`steamer`:`schooner`:Z.year>=1965&&Z.industry>55&&e%8==0?e%16==0?`container`:`factory`:Z.year>=1965&&Z.tourism>45&&e%6==0?`ferry`:Z.year>=1970&&Z.tourism>42&&e%4==0?`yacht`:e%5==0&&Z.year<1960?`steamer`:`trawler`}function Vf(e,t,n,r,i,a){let o=new Dn;o.position.set(e,0,t),o.rotation.y=i,o.add(Q(r,.25,n,a,0,.36,-n/2));let s=up(`#4b3427`,.7);for(let e=0;e<Math.floor(n/2.4);e+=1)for(let t of[-1,1]){let n=new J(new Oi(.12,.15,1.25,8),s);n.position.set((r/2-.12)*t,-.12,-1.2-e*2.35),o.add(n)}return o}function Hf(e,t,n,r,i,a){let o=Q(n,.72,r,a,e,.28,t);o.rotation.y=i,Kd.add(o)}function Uf(e){let t=new li({color:`#dffcff`,transparent:!0,opacity:.55}),n=new zi(_d.map(([t,n])=>new U(t,e+.035,n-.28))),r=new _i(new kr().setFromPoints(n.getPoints(110)),t);Kd.add(r)}function Wf(){for(let e=0;e<_d.length-1;e+=2){let[t,n]=_d[e],[r,i]=_d[e+1],a=Q(Math.hypot(r-t,i-n),.55,.34,`#7c8178`,(t+r)/2,.42,(n+i)/2+.2);a.rotation.y=Math.atan2(i-n,r-t),Kd.add(a)}}function Gf(e,t,n){let r=new Dn;r.position.set(e,.42,t),r.add(Q(.42*n,4.2*n,.42*n,`#f59e0b`,0,2.1*n,0));let i=Q(5.8*n,.22*n,.22*n,`#fbbf24`,2.7*n,4.15*n,0);i.rotation.z=.14,r.add(i),r.add(Q(.16*n,1.2*n,.16*n,`#111827`,5.1*n,3.45*n,0)),Kd.add(r)}function Kf(){Hf(31,-17.8,27,4.6,.02,`#9ca3af`);for(let e=0;e<36;e+=1){let t=Math.floor(e/9),n=[`#dc2626`,`#2563eb`,`#f97316`,`#16a34a`,`#eab308`][e%5],r=Q(1.75,.7,.82,n,20+e%9*2.15,.92+(e%3==0?.72:0),-19.8-t*1.15);Kd.add(r)}Gf(21,-15.3,1.3),Gf(31,-15.6,1.45),Gf(41,-15.8,1.25)}function qf(e){let t=e>1.1?`#d97706`:`#f59e0b`;for(let e=0;e<9;e+=1){let n=Q(2.1,.34,.32,t,-13+e*3.4,.72,-1.35);n.rotation.y=.02,Kd.add(n)}}function Jf(e,t,n,r,i){let a=Q(n,.05,r,`#756b5a`,e,.19,t);a.rotation.y=i,qd.add(a)}function Yf(){if(!(Z.year>1935&&Z.industry>70))for(let e=0;e<4;e+=1){let t=new Dn;t.position.set(-18+e*2.2,.25,4.1+e%2*1.25),t.rotation.y=-.18,t.add(Q(1.7,.08,.08,`#5b4636`,0,1.2,0));for(let e of[-.7,.7])t.add(Q(.08,1.15,.08,`#5b4636`,e,.68,0));for(let e=0;e<4;e+=1)t.add(Q(.18,.76,.035,`#e8d5a9`,-.55+e*.36,.72,-.04));qd.add(t)}}function Xf(){let e=bp(Math.round(yp(Z.year,900,1990)*26+yp(Z.year,1750,1990)*24+yp(Z.year,1930,1990)*26+Z.population*.18),0,82),t=[{x:-34,z:14,columns:7,rows:4,spacingX:5.1,spacingZ:4.1},{x:2,z:15,columns:7,rows:4,spacingX:5,spacingZ:4},{x:-24,z:30,columns:9,rows:2,spacingX:5.2,spacingZ:4.2}],n=0,r=0;for(let i of t)for(let t=0;t<i.rows;t+=1)for(let a=0;a<i.columns;a+=1){if(n>=e)return;let o=i.x+a*i.spacingX+($(r)-.5)*.8,s=i.z+t*i.spacingZ+($(r+4)-.5)*.8,c=Z.year>=1930,l=Z.year>=1965,u=l&&n%9==0?`highrise`:l&&n%5==0?`office`:c&&n%3==0?`apartment`:Z.year>=1750&&n%4==0?`warehouse`:Z.year>=900&&n%6==0?`market`:Z.year<1450?`cottage`:`warehouse`,d=u===`highrise`?11+$(r+2)*15:u===`office`?7+$(r+2)*7:u===`apartment`?4.2+$(r+2)*4.5:u===`warehouse`?2.5+$(r+2)*2.5:2.1+$(r+2)*1.6,f=Zf(u,r);qd.add(Ff({name:`Urban ${u} ${n+1}`,year:Z.year,x:o,z:s,w:u===`highrise`?3.8+$(r+3)*2.6:3+$(r+3)*3.2,d:u===`highrise`?3.4+$(r+5)*2.2:2.5+$(r+5)*3.4,h:d,color:f.body,roof:f.roof,rotation:($(r+8)-.5)*.28,kind:u})),n+=1,r+=1}}function Zf(e,t){if(e===`highrise`||e===`office`){let e=[`#8fb5c7`,`#9aa9b5`,`#b6c4cf`,`#6f8ea3`];return{body:e[t%e.length],roof:`#1f2937`}}if(e===`apartment`){let e=[`#d6b58a`,`#c4a484`,`#b9afa2`,`#e7c69a`];return{body:e[t%e.length],roof:`#475569`}}if(e===`warehouse`){let e=[`#8a8d86`,`#9d7651`,`#7f8c8d`,`#b08a64`];return{body:e[t%e.length],roof:`#334155`}}let n=[`#c58f65`,`#d6b182`,`#b87f58`,`#e0d3bb`];return{body:n[t%n.length],roof:`#563627`}}function Qf(e,t){let n=new Dn;n.position.set(e,.18,t);for(let e=0;e<3;e+=1){let t=new J(new Oi(.95,.95,1.45,24),up(e===1?`#b91c1c`:`#cbd5e1`,.4));t.rotation.z=Math.PI/2,t.position.set(e*2.15,.95,0),n.add(t)}return n}function $f(e,t,n){for(let r=0;r<n;r+=1){let n=new J(new Ei(1.35,.06,.85),new ao({color:`#102a43`,metalness:.15,roughness:.28,emissive:`#0ea5e9`,emissiveIntensity:.05}));n.position.set(e+r%4*1.65,.78,t+Math.floor(r/4)*1.1),n.rotation.x=-.45,n.rotation.y=-.12,qd.add(n)}}function ep(e,t,n){let r=new Dn;r.position.set(e,.1,t);let i=new J(new Oi(.12*n,.22*n,7.5*n,16),up(`#e2e8f0`,.38));i.position.y=3.75*n,r.add(i);let a=new J(new Ja(.34*n,16,12),up(`#f8fafc`,.35));a.position.set(0,7.72*n,0),r.add(a);let o=new Dn;o.position.copy(a.position);for(let e=0;e<3;e+=1){let t=new J(new Ei(.18*n,2.45*n,.05*n),up(`#f8fafc`,.42));t.position.y=1.22*n,t.rotation.z=e*Math.PI*2/3,o.add(t)}return Zd.push(o),r.add(o),r}function tp(e,t,n){let r=new Dn;r.position.set(e,.28,t),r.rotation.y=.08,r.add(Q(1.35,.42,.72,n,0,.28,0)),r.add(Q(.72,.34,.58,`#bfdbfe`,-.08,.66,-.02));for(let e of[-.43,.43])for(let t of[-.3,.3]){let n=new J(new Oi(.14,.14,.08,12),up(`#111827`,.55));n.rotation.z=Math.PI/2,n.position.set(e,.12,t),r.add(n)}return r}function np(e,t,n,r){let i=new Dn;i.position.set(e,t,n);let a=Z.storminess/100,o=new ao({color:new K().setHSL(.6,.16,.92-a*.42),roughness:.9,transparent:!0,opacity:.72+a*.18});for(let e=0;e<5;e+=1){let t=new J(new Ja((.8+$(e)*.55)*r,16,12),o);t.position.set((e-2)*.88*r,$(e+5)*.45*r,$(e+9)*.38*r),i.add(t)}return i}function rp(e){let t=new kr;t.setAttribute(`position`,new q([-.46,0,0,0,.12,0,0,.12,0,.46,0,0],3));let n=new Dn,r=new xi(t,new li({color:`#f8fafc`,transparent:!0,opacity:.92}));return n.add(r),n.userData.index=e,n}function ip(){let e=[];for(let t=0;t<180;t+=1){let n=-48+$(t)*96,r=-2+$(t+5)*28,i=-35+$(t+9)*55;e.push(n,r,i,n+.45,r-1.5,i+.05)}let t=new kr;return t.setAttribute(`position`,new q(e,3)),new xi(t,new li({color:`#b8d7f6`,transparent:!0,opacity:.42}))}function ap(){let e=new Dn,t=new Br({color:`#bff7ff`,transparent:!0,opacity:.74,side:2});for(let n=0;n<14;n+=1){let r=new J(new Di(.22+$(n)*.16,12),t);r.position.set(-24+$(n+1)*48,_p()+.1,-24+$(n+2)*14),r.rotation.x=-Math.PI/2,r.scale.set(1.8,.32,1),e.add(r)}return e}function op(e,t,n,r,i){let a=new J(new ki(n,r,9),new ao({color:i,roughness:.96}));a.position.set(e,r/2-.2,t),a.rotation.y=$(n)*Math.PI,a.receiveShadow=!0,a.castShadow=!0,Gd.add(a)}function sp(e,t,n){let r=new Dn;r.position.set(e,.1,t);let i=new J(new Oi(.12*n,.17*n,.9*n,8),up(`#6b4423`,.85));i.position.y=.45*n,r.add(i);let a=new J(new ki(.72*n,1.8*n,9),up(`#244f2d`,.92));return a.position.y=1.45*n,r.add(a),Sp(r),r}function cp(e,t,n,r){for(let i=0;i<4;i+=1){let a=new J(new Ja(.28+i*.08,14,10),new ao({color:`#9ca3af`,roughness:1,transparent:!0,opacity:.22}));a.position.set(t+i*.14,n+i*.45,r+i*.06),a.userData.baseY=a.position.y,a.userData.phase=i*.55+$(i),Qd.push(a),e.add(a)}}function lp(e,t,n,r){let i=Q(t,.16,.62,r,0,1.58,-n/2-.38);i.rotation.x=-.18,e.add(i)}function Q(e,t,n,r,i,a,o){let s=new J(new Ei(e,t,n),up(r,.72));return s.position.set(i,a,o),s}function up(e,t){return new ao({color:e,roughness:t,metalness:.03})}function dp(e,t,n,r){let i=new kr;return i.setAttribute(`position`,new q([-e/2,0,-t/2,e/2,0,-t/2,0,n,-t/2,-e/2,0,t/2,e/2,0,t/2,0,n,t/2],3)),i.setIndex([0,1,2,3,5,4,0,2,5,0,5,3,1,4,5,1,5,2]),i.computeVertexNormals(),new J(i,up(r,.68))}function fp(e,t,n){let r=e/2,i=t,a=n/2,o=new kr;return o.setAttribute(`position`,new q([-r,0,-a,r,0,-a,r*.72,i,-a*.82,-r*.72,i,-a*.82,-r,0,a*.62,r,0,a*.62,0,i*.82,a],3)),o.setIndex([0,1,2,0,2,3,4,6,5,0,4,5,0,5,1,1,5,6,1,6,2,0,3,6,0,6,4,3,2,6]),o.computeVertexNormals(),o}function pp(e,t){let n=new kr;return n.setAttribute(`position`,new q(e.flat(),3)),n.setIndex([0,1,2]),n.computeVertexNormals(),new J(n,new ao({color:t,roughness:.82,side:2}))}function mp(e,t,n){e.moveTo(t,-n)}function hp(e,t,n){e.lineTo(t,-n)}function gp(e,t,n,r,i,a,o){e.bezierCurveTo(t,-n,r,-i,a,-o)}function _p(){return-.22+Z.seaLevel*.0046}function vp(e){return e<0?92:e<900?64:e<1750?36:e<1880?15:e<1965?8:4.5}function yp(e,t,n){let r=bp((e-t)/(n-t),0,1);return r*r*(3-2*r)}function bp(e,t,n){return Math.min(n,Math.max(t,e))}function $(e){return(Math.sin(e*91.345+17.23)+1)/2}function xp(e){let t=document.querySelector(e);if(!t)throw Error(`Expected ${e} to exist.`);return t}function Sp(e){e.traverse(e=>{e instanceof J&&(e.castShadow=!0,e.receiveShadow=!0)})}function Cp(e){for(let t of[...e.children])e.remove(t),wp(t)}function wp(e){e.traverse(e=>{if(e instanceof J||e instanceof xi){e.geometry.dispose();let t=e.material;Array.isArray(t)?t.forEach(e=>e.dispose()):t.dispose()}})}